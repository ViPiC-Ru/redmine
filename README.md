...
```bat
cscript redmine.min.js https://redmine.org 8dbfd7b0a9c9279a97fedfb82710aed96bcf53fc issues.change 46 status:8;done:10;notes:"{author.name}, ваша заявка автоматически зарегистрирована в системе." description:заявка;10:серия;private:true;assigned.id:{author.id}
```