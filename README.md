...
```
- `<fields>` - Соответствие **идентификатора** поля пользователя и **имени** атрибута **LDAP** в формате `id:name#format;id:name`. Для **настраиваемых полей** пользователей укажите идентификатор поля в виде числа. Для **форматирования** значения укажите имя фильтра после разделителя `#`.
...
## Форматирование
В **параметрах**, которые поддерживают форматирование, можно указывать названия фильтров для изменения значений. Поддерживаються следующие фильтры:
