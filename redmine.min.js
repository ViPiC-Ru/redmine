...
(function(c,C,E){c.lib.extend(c,{fun:{str2val:function(a){switch(!0){case "true"==a:a=!0;break;case "false"==a:a=!1;break;case !!a&&!isNaN(a):a=Number(a);break;case "--"==a.charAt(4)+a.charAt(7)&&"::"==a.charAt(13)+a.charAt(16)&&"TZ"==a.charAt(10)+a.charAt(19):a=Date.UTC(Number(a.substring(0,4)),Number(a.substring(5,7))-1,Number(a.substring(8,10)),Number(a.substring(11,13)),Number(a.substring(14,16)),Number(a.substring(17,19))),a=new Date(a)}return a},val2str:function(a){switch(!0){case c.lib.validate(a,
"string"):case c.lib.validate(a,"number"):a=""+a;break;case c.lib.validate(a,"boolean"):a=a?"true":"false";break;case c.lib.validate(a,"date"):a=a.getUTCFullYear()+"-"+c.lib.strPad(a.getUTCMonth()+1,2,"0","left")+"-"+c.lib.strPad(a.getUTCDate(),2,"0","left")+"T"+c.lib.strPad(a.getUTCHours(),2,"0","left")+":"+c.lib.strPad(a.getUTCMinutes(),2,"0","left")+":"+c.lib.strPad(a.getUTCSeconds(),2,"0","left")+"Z";break;default:a=null}return a},xml2obj:function(a){var b={},l=null,m=!0;if(a){var d=a.documentElement?
a.documentElement:a;for(var g=0,e=d.attributes.length;g<e;g++){var f=d.attributes[g];m=!1;"type"!=f.name&&"array"!=f.value?b[f.name]=c.fun.str2val(f.value):a.documentElement||(l=!0)}l&&(b=[]);g=0;for(e=a.childNodes.length;g<e;g++)switch(d=a.childNodes[g],d.nodeType){case 1:m=!1;f=c.fun.xml2obj(d);l?b.push(f):b[d.nodeName]=f;break;case 3:m=!1,b=c.fun.str2val(d.nodeValue)}}else m=!1;return m?null:b},obj2xml:function(a,b){var l="item",m=null,d=null;var g={custom_fields:"custom_field",memberships:"membership",
groups:"group",issues:"issue",users:"user",roles:"role"};if(b)b.ownerDocument&&(m=b.ownerDocument);else{var e=["MSXML2.DOMDocument.6.0","MSXML2.DOMDocument.3.0","MSXML2.DOMDocument"];for(var f=0,h=e.length;!m&&f<h;f++){var r=e[f];try{m=new ActiveXObject(r)}catch(p){}}e=m.createProcessingInstruction("xml",'version="1.0" encoding="UTF-8"');m.appendChild(e)}if(m){d=m.createDocumentFragment();if(c.lib.validate(a,"array"))for(b&&(b.setAttribute("type","array"),e=b.nodeName,l=g[e]?g[e]:l),f=0,h=a.length;f<
h;f++){var k=m.createElement(l);for(var n in a[f])switch(r=a[f][n],e=c.fun.val2str(r),!0){case "value"==n&&"custom_field"==l:case "membership"==l:case "user"==l:e=r,r={},r[n]=e;case !e:e=c.fun.obj2xml(r,k);k.appendChild(e);break;default:k.setAttribute(n,e)}d.appendChild(k)}if(c.lib.validate(a,"object")){b&&(l=b.nodeName);for(n in a)switch(r=a[n],e=c.fun.val2str(r),!0){case !!e&&"project"==l:case !!e&&"tracker"==l:case !!e&&"priority"==l:case !!e&&"author"==l:case !!e&&"category"==l:b&&b.setAttribute(n,
e);break;case !!b||!k&&!e:k=m.createElement(n),e=e?m.createTextNode(e):c.fun.obj2xml(r,k),k.appendChild(e),d.appendChild(k)}if(!b&&k)for(n in a)r=a[n],(e=c.fun.val2str(r))&&k.setAttribute(n,e)}b||m.appendChild(d)}return b?d:m},item2user:function(a,b){var l={},m=0;m||a||(m=1);m||b||(m=2);if(!m){var d=a.get("userAccountControl");l.status=d&2?c.val.userLocked:c.val.userActive}if(!m)for(var g in b)(d=b[g])&&(d=c.lib.template(d,function(e){var f=!0;var h=a;for(var r=0,k=e.length;f&&r<k;r++){var n=e[r];
try{r&&(h=c.wsh.ldap(h)[0]),h?h=h.get(n):f=!1}catch(p){f=!1}}if(f)return h},c.fun.filter)),d=c.fun.str2val(d),isNaN(g)?l[g]=d:(l.custom_fields||(l.custom_fields=[]),l.custom_fields.push({id:g,value:d}));return l},getAttribute:function(a,b){var l="";var m={"project.id":["project_id"],"tracker.id":["tracker_id"],"status.id":["status_id"],"priority.id":["priority_id"],"author.id":["author_id"],"assigned_to.id":["assigned_to_id"],"category.id":["category_id"],"fixed_version.id":["fixed_version_id"],"parent.id":["parent_issue_id"]};
switch(a){case "custom":for(var d in m){a=0;for(var g=m[d].length;a<g;a++)b==m[d][a]&&(l=d)}break;case "original":for(d in m)b==d&&(l=m[d][0])}return l},filter:function(a,b){var l,m;var d=[];a=a?""+a:"";var g="(";var e=")";if(a.indexOf(e)>a.indexOf(g)){var f=c.lib.strim(a,g,e,!1,!1);f=f.split('"').join("").split("'").join("");a=c.lib.strim(a,"",g,!1,!1);d=f.split(c.val.delimParam)}g="[";e="]";f=a.split(e+g).join(c.val.delimId);f=f.split(g).join(c.val.delimId);f=f.split(e).join("");f=f.split('"').join("").split("'").join("");
var h=f.split(c.val.delimId);switch(!0){case "phone"==a.toLowerCase():a=b?c.lib.trim(""+b):"";a=a.replace(/\D/g,"");!a.indexOf("8")&&10<a.length&&(a="7"+a.substr(1));e=[{index:0,length:a.length-10},{index:a.length-10,length:3},{index:a.length-7,length:3},{index:a.length-4,length:2},{index:a.length-2,length:2}];h=0;for(var r=e.length;h<r;h++){var k=e[h].length+Math.min(0,e[h].index);e[h]=a.substr(Math.max(0,e[h].index),Math.max(0,k))}!e[0]&&e[1]&&(e[0]=7);a=e[0]?"+"+e[0]:"";a+=e[1]?" ("+e[1]+") ":
"";a+=e[2]?e[2]+"-":"";a+=e[3]?e[3]+(e[2]?"-":""):"";return a+=e[4]?e[4]:"";case "normal"==a.toLowerCase():a=b?c.lib.trim(""+b):"";e=[160];f=a;h=0;for(r=e.length;h<r;h++)k=String.fromCharCode(e[h]),f=f.split(k).join("");a=c.lib.trim(f);e=["FW:","RE:"];var n=!1;h=0;for(r=e.length;h<r&&!n;h++)k=e[h],(l=a.indexOf(k))||(n=!0);n&&(f=a.substring(l+k.length),a=c.lib.trim(f));e=[".","!","?"];n=!1;h=0;for(r=e.length;h<r&&!n;h++)k=e[h],l=a.indexOf(k),a.length-l==k.length&&(n=!0);n&&(f=a.substring(0,l),a=c.lib.trim(f));
f=a;f.charAt(0)==f.charAt(0).toLowerCase()&&(f=f.charAt(0).toUpperCase()+f.substring(1));f=f.split("  ").join(" ");f=f.split(" \n").join("\n");return f=f.split("\n ").join("\n");case "crop"==a.toLowerCase():a=b?c.lib.trim(""+b):"";d="**";e=["Importance:","Subject:","From:"];n=!1;var p=a.split("\n");h=0;for(r=e.length;h<r&&!n;h++){var t=0;for(g=p.length;t<g&&!n;t++)for(f=p[t],b=0,m=2;b<m&&!n;b++)k=b?e[h]:d+e[h],(l=f.indexOf(k))||(n=!0)}n&&(f=p.slice(t).join("\n"),a=c.lib.trim(f));f=a;f.charAt(0)==
f.charAt(0).toLowerCase()&&(f=f.charAt(0).toUpperCase()+f.substring(1));return f;case "clear"==a.toLowerCase():a=b?c.lib.trim(""+b):"";g="[";e=")";p=a.split("](");h=0;for(r=p.length;h<r;h++)f=p[h],h&&~f.indexOf(e)&&(f=c.lib.strim(f,e,null,!1,!1)),~f.indexOf(g)&&(f=c.lib.strim(f,null,g,!1,!0)),p[h]=f;f=p.join("");a=c.lib.trim(f);return f=a.split("*").join("");case "hash"==a.toLowerCase():return a=b?c.lib.trim(""+b):"",a=c.lib.strim(a,"#","",!1,!1);case "set"==a.toLowerCase():a=b?c.lib.trim(""+b):"";
var q=!0;a=a?0<d.length?d[0]||a:"true":1<d.length?d[1]||(q=!1):"false";if(q)return a;break;case "map"==a.toLowerCase():a=b?c.lib.trim(""+b):"";q=!1;h=0;for(r=d.length;h<r&&!q;h++)~d[h].indexOf(c.val.delimMap)&&(k=c.lib.strim(d[h],"",c.val.delimMap,!1,!1),"*"==k||a==k||!a&&!k)&&(a=c.lib.strim(d[h],c.val.delimMap,"",!1,!1),q=!0);if(q)return a;break;case "replace"==a.toLowerCase():return a=b?""+b:"",d[0]&&(a=a.split(d[0]).join(d[1]||"")),a;case "context"==h[0].toLowerCase():a=b?c.lib.trim(""+b):"";q=
!1;switch(h[1]){case "from":d="**";e=["From:"];n=!1;p=a.split("\n");h=0;for(r=e.length;h<r&&!n;h++)for(t=0,g=p.length;t<g&&!n;t++)for(f=p[t],b=0,m=2;b<m&&!n;b++)k=b?e[h]:d+e[h],(l=f.indexOf(k))||(n=!0);n&&(f=a.substring(l+k.length),g="<",e=">",f.indexOf(e)>f.indexOf(g)&&(f=c.lib.strim(f,g,e,!1,!1)),g="(mailto:",e=")",f.indexOf(e)>f.indexOf(g)&&(f=c.lib.strim(f,g,e,!1,!1)),(a=c.lib.trim(f))&&(q=!0))}if(q)return a;break;case "user"==h[0].toLowerCase():p||(p={include:"groups"});case "issue"==h[0].toLowerCase():p||
(p={include:"journals,watchers"});case "project"==h[0].toLowerCase():p||(p={include:"trackers"});(l=b&&b.id?b.id:isNaN(b)?null:b)?(k=h.shift().toLowerCase(),b=c.api.redmine("get",k+"s/"+l,p),b=b[k]?b[k]:null):b?(k=h.shift().toLowerCase()+"s",b={name:b},b=c.api.redmine("get",k,b),b=b[k]&&1==b[k].length?b[k][0]:null):b=null;q=p=b;b=0;for(m=h.length;q&&b<m;b++)if(k=h[b],isNaN(k))(q=k in p)&&(p=p[k]);else if(k=Number(k),q=p=p.custom_fields)for(q=!1,t=0,g=p.length;!q&&t<g;t++)if(q=k==p[t].id)p=p[t].value;
if(q)return p;break;case "journal"==h[0].toLowerCase():l="details";k=h.shift().toLowerCase()+"s";a=h.pop();f=h.join(c.val.delimId);f=c.fun.getAttribute("original",f)||f;if(b&&b[k])for(h=0,r=b[k].length;h<r;h++)if(b[k][h][l])for(t=0,g=b[k][h][l].length;t<g;t++)if(p=b[k][h][l][t],e=p.new_value||"",e=c.fun.str2val(e),q=c.lib.validate(e,"boolean"),q=!c.lib.compare(e,q?a?!0:!1:a),!q&&isNaN(e)&&(q=c.lib.hasValue(""+a,e,!1)),q=q&&(!f||f==p.name))m=b[k][h].user.id;if(m)return m}},fixUrlPath:function(a){a?
"/"!=a.substring(a.length-1)&&(a+="/"):a="/";return a}},method:{"users.sync":function(a,b,l){var m,d,g,e={},f=0;f||(a=c.lib.url2obj(a),c.lib.hasValue(["ldap"],a.scheme,!1)?c.val.apiADPath=a.path||a.domain:f=7);if(!f){b=b?c.lib.str2obj(b,!1,c.val.delimKey,c.val.delimVal):{};for(d in b)(a=b[d])&&(b[d]=a.split('"').join("").split("'").join("")),m||(m=d);b.login&&b.firstname&&b.mail&&b.lastname||(f=8)}f||(g=c.api.ad("WHERE 'objectClass' = 'user'"));if(!f)for(var h=0,r=g.length;h<r;h++){a=g[h];var k=c.fun.item2user(a,
b);k.login&&k.firstname&&k.lastname&&(k.mail||(k.status=c.val.userLocked,delete k.mail),(d=k[m].toLowerCase())&&(e[d]=k))}k=[c.val.userActive,c.val.userRegistered,c.val.userLocked];g=[];h=0;for(r=k.length;!f&&h<r;h++){var n=k[h];for(b=null;!b||b.total_count>b.offset;b.offset+=b.limit){b={offset:b?b.offset:0,status:n};b=c.api.redmine("get","users",b);b.users||(b.users=[]);for(var p=0,t=b.users.length;p<t;p++)a=b.users[p],a.status=n,g.push(a)}}f||g.length||(f=9);if(!f)for(h=0,r=g.length;h<r;h++)if(a=
g[h],d=a[m].toLowerCase(),k=e[d]){if(b=c.lib.difference(k,a,function(q,u){return q.id==u.id&&q.value!=u.value}))l&&(b.auth_source_id=l),b={user:b},b=c.api.redmine("put","users/"+a.id,b);delete e[d]}if(!f)for(d in e)k=e[d],c.val.userActive==k.status&&(l&&(k.auth_source_id=l),b={user:k},b=c.api.redmine("post","users",b)),delete e[d];return f},"issues.sync":function(a,b,l,m){var d,g,e,f,h,r={},k=0;m||(m=l,l=null);k||b&&!isNaN(b)||(k=7);k||(a=c.lib.url2obj(a),k||(a.fragment?(c.val.apiCherwellClient=a.fragment,
delete a.fragment):k=8),k||(a.password&&a.user?(c.val.apiCherwellUser=a.user,c.val.apiCherwellPassword=a.password,delete a.password,delete a.user):k=9),k||(a.scheme&&a.domain?(a.path=c.fun.fixUrlPath(a.path),c.val.apiCherwellUrl=c.lib.obj2url(a)):k=10));if(!k&&(l=l?c.lib.str2obj(l,!1,c.val.delimKey,c.val.delimVal):null))for(w in l)(d=l[w])&&(l[w]=d.split('"').join("").split("'").join(""));if(!k){m=m?c.lib.str2obj(m,!1,c.val.delimKey,c.val.delimVal):{};for(w in m)(d=m[w])&&(m[w]=d.split('"').join("").split("'").join("")),
h||(h=w);if(!m.SuppliersReference||m.IncidentID)k=11}if(!k){var n=c.api.cherwell("get","getuserbyloginid/loginid/"+c.val.apiCherwellUser);n.recordId?g=n.recordId:k=12}k||(n=c.api.cherwell("get","getbusinessobjectsummary/busobname/Incident"),n.length&&n[0].busObId?e=n[0].busObId:k=13);if(!k)if(n=c.api.cherwell("get","getbusinessobjectschema/busobid/"+e),n.fieldDefinitions){var p=n.fieldDefinitions;var t={};for(w in m){n=!1;var q=[w,"IncidentID"];for(var u=0,y=p.length;u<y;u++){a=p[u];for(var v=0,x=
q.length;v<x;v++){var z=q[v];a.name==z&&(t[a.name]=a.fieldId,v||(n=!0))}}n||(k=15)}}else k=14;if(!k)for(u=1,p=[],n=null;!n||n.hasMoreRecords&&!k;u++)n={pagenumber:u},n=c.api.cherwell("get","getsearchresults/association/"+e+"/scope/User/scopeowner/"+g+"/searchname/"+b,n),!n.hasError&&n.businessObjects?p=p.concat(n.businessObjects):k=16;if(!k)for(u=0,y=p.length;u<y;u++){a=p[u];var B={};v=0;for(x=a.fields.length;v<x;v++)if(f=t[a.fields[v].name]){d=a.fields[v].value;q=[160,13];var w=0;for(n=q.length;d&&
w<n;w++)z=String.fromCharCode(q[w]),d=(""+d).split(z).join("");B[f]=d}(w=B[t[h]])&&(r[w]=B)}if(!k)for(p=[],n=null;!n||n.total_count>n.offset;n.offset+=n.limit)n={offset:n?n.offset:0},b&&(n.query_id=b),n=c.api.redmine("get","issues",n),n.issues&&(p=p.concat(n.issues));if(!k)for(u=0,y=p.length;u<y;u++){a=p[u];a["true"]=!0;a["false"]=!1;for(z in a){var A=a[z];(z=c.fun.getAttribute("custom",z))&&(a[z]=A)}g=!0;if(l)for(w in l){b=l[w];if(isNaN(w))for(d=n=a,q=w.split(c.val.delimId),v=0,x=q.length;g&&v<x;v++)z=
q[v],(g=z in n)&&(d=n=n[z]);else for(g=!1,q=a.custom_fields?a.custom_fields:[],v=0,x=q.length;!g&&v<x;v++)if(A=q[v],g=A.id==Number(w))d=A.value;if(g)for(b&&(b=c.lib.template(b,a,c.fun.filter)),q=b.split(c.val.delimParam),g=!1,v=0,x=q.length;v<x&&!g;v++)b=q[v],b=c.fun.str2val(b),g=c.lib.validate(b,"boolean"),g=!c.lib.compare(b,g?d?!0:!1:d),!g&&isNaN(b)&&(g=c.lib.hasValue(""+d,b,!1));if(!g)break}if(g){B=A=null;var D=0;for(w in m)A||(A={}),(d=m[w])&&(d=c.lib.template(d,a,c.fun.filter)),d=c.fun.str2val(d),
f=t[w],w==h&&(B=r[d]),B&&B[f]==d||D++,A[f]=d}if(g&&D){n={busObId:e,persist:!0,fields:[]};B&&(n.busObPublicId=B[t.IncidentID]);for(f in A)n.fields.push({value:A[f],fieldId:f,dirty:!0});c.api.cherwell("post","savebusinessobject",n)}}return k},"issues.change":function(a,b,l){var m,d,g,e,f=0;isNaN(a)&&(l=b,b=a,a=null);l||(l=b,b=null);if(!f&&(b=b?c.lib.str2obj(b,!1,c.val.delimKey,c.val.delimVal):null))for(var h in b)(d=b[h])&&(b[h]=d.split('"').join("").split("'").join(""));if(!f)if(l=l?c.lib.str2obj(l,
!1,c.val.delimKey,c.val.delimVal):null)for(h in l)(d=l[h])&&(l[h]=d.split('"').join("").split("'").join(""));else f=7;if(!f){var r=[];for(g=null;!g||g.total_count>g.offset;g.offset+=g.limit)g={offset:g?g.offset:0},a&&(g.query_id=a),g=c.api.redmine("get","issues",g),g.issues&&(r=r.concat(g.issues))}if(!f)for(var k=0,n=r.length;k<n;k++){var p=r[k];p["true"]=!0;p["false"]=!1;for(m in p){var t=p[m];(m=c.fun.getAttribute("custom",m))&&(p[m]=t)}var q=!0;if(b)for(h in b){a=b[h];if(isNaN(h))for(d=g=p,list=
h.split(c.val.delimId),u=0,y=list.length;q&&u<y;u++)m=list[u],(q=m in g)&&(d=g=g[m]);else{q=!1;list=p.custom_fields?p.custom_fields:[];for(var u=0,y=list.length;!q&&u<y;u++)if(t=list[u],q=t.id==Number(h))d=t.value}if(q)for(a&&(a=c.lib.template(a,p,c.fun.filter)),list=a.split(c.val.delimParam),q=!1,u=0,y=list.length;u<y&&!q;u++)a=list[u],a=c.fun.str2val(a),q=c.lib.validate(a,"boolean"),q=!c.lib.compare(a,q?d?!0:!1:d),!q&&isNaN(a)&&(q=c.lib.hasValue(""+d,a,!1));if(!q)break}if(q){t=null;var v=0;for(h in l){t||
(t={});(d=l[h])&&(d=c.lib.template(d,p,c.fun.filter));d=c.fun.str2val(d);h=c.fun.getAttribute("original",h)||h;switch(h){case "watcher":d&&(d=isNaN(d)?!1:Number(d));d&&(g={include:"watchers"},g=c.api.redmine("get","issues/"+p.id,g),g.issue&&g.issue.watchers?e=g.issue.watchers:d=!1);if(d){var x=null;u=0;for(y=e.length;!x&&u<y;u++)x=e[u],Math.abs(d)!=x.id&&(x=null)}d&&(0<d&&!x&&(g={user_id:d},g={watcher:g},c.api.redmine("post","issues/"+p.id+"/watchers",g)),0>d&&x&&(d=Math.abs(d),c.api.redmine("delete",
"issues/"+p.id+"/watchers/"+d)));h=null}h&&(isNaN(h)?t[h]=d:(t.custom_fields||(t.custom_fields=[]),t.custom_fields.push({id:h,value:d})),v++)}}q&&v&&(g={issue:t},c.api.redmine("put","issues/"+p.id,g))}return f}},api:{redmine:function(a,b,l){var m={},d=0;if(!d)switch(a.toLowerCase()){case "get":var g=!1;break;case "head":g=!1;break;case "delete":g=!1;break;default:g=!0}!d&&l&&g&&((l=c.fun.obj2xml(l))||(d=1));if(!d){b=c.val.apiReadmineUrl+b+".xml";var e={"Cache-Control":"no-store","If-None-Match":"empty"};
c.val.apiReadmineKey&&(e["X-Redmine-API-Key"]=c.val.apiReadmineKey);e=c.lib.xhr(a,b,e,l,!1,null,c.val.apiReadmineUser,c.val.apiReadminePassword);l=e.responseXML;c.lib.validate(l,"xml")||(d=2)}d||(l=c.fun.xml2obj(e.responseXML))&&(m=l);return m},cherwell:function(a,b,l){var m={},d=0;if(!d&&!c.val.apiCherwellToken){var g=c.val.apiCherwellUrl+"token";var e=new ActiveXObject("MSXML2.ServerXMLHTTP");e.open("POST",g,!1);e.setRequestHeader("Content-Type","application/x-www-form-urlencoded");e.send(c.lib.obj2str({client_id:c.val.apiCherwellClient,
username:c.val.apiCherwellUser,password:c.val.apiCherwellPassword,grant_type:"password"},!0));e.responseText&&200==e.status?(g=JSON.parse(e.responseText).access_token)?c.val.apiCherwellToken=g:d=2:d=1}if(!d)switch(a.toLowerCase()){case "get":var f=!1;break;case "head":f=!1;break;case "delete":f=!1;break;default:f=!0}!d&&l&&f&&(l=JSON.stringify(l));d||!l||f||(l=c.lib.obj2str(l,!0),b=~b.indexOf("?")?b+"&":b+"?",b+=l,l=null);if(!d){g=c.val.apiCherwellUrl+"api/V1/"+b;e=new ActiveXObject("MSXML2.ServerXMLHTTP");
e.open(a.toUpperCase(),g,!1);e.setRequestHeader("Accept","application/json");e.setRequestHeader("Content-Type","application/json");e.setRequestHeader("Authorization","Bearer "+c.val.apiCherwellToken);try{l?e.send(l):e.send(),e.responseText&&200==e.status||(d=4)}catch(h){d=3}}d||(l=JSON.parse(e.responseText))&&(m=l);return m},ad:function(a){return c.wsh.ldap(a,c.val.apiADPath)}},init:function(){var a,b=[],l=0,m=0;if(!m){if(l<C.arguments.length){var d=C.arguments(l);d=c.lib.url2obj(d);!m&&d.fragment&&
(d.user||d.password?m=2:(c.val.apiReadmineKey=d.fragment,delete d.fragment));!m&&d.user&&(d.password&&!d.fragment?(c.val.apiReadmineUser=d.user,c.val.apiReadminePassword=d.password,delete d.password,delete d.user):m=3);m||(d.scheme&&d.domain?(d.path=c.fun.fixUrlPath(d.path),c.val.apiReadmineUrl=c.lib.obj2url(d)):m=4)}else m=1;l++}m||(l<C.arguments.length?(d=C.arguments(l),(a=c.method[d])||(m=6)):m=5,l++);if(!m)for(var g=C.arguments.length;l<g;l++)d=C.arguments(l),b.push(d);m||(m=a.apply(c,b));C.quit(m)}})})(readmine,
WSH);readmine.init();
