...
if(g=g&&(!p||p==c.name))var q=d[a][l].user.id}if(q)return q}}},method:{"users.sync":function(a,d,k){var g,b,e={},c=0,l=0;if(!l){a=a?f.lib.str2obj(a,!1,f.val.delimKey,f.val.delimVal):{};for(m in a)(g=a[m])&&(a[m]=g.split('"').join(""));a.login&&a.firstname&&a.mail&&a.lastname||(l=1)}l||(b=f.wsh.ldap("WHERE 'objectClass' = 'user'",d));if(!l){var m=0;for(g=b.length;m<g;m++){d=b[m];var h=f.fun.item2user(d,a);if(h.login&&h.firstname&&h.lastname){h.mail||(h.status=f.val.stLocked,delete h.mail);var n=h.login.toLowerCase();
e[n]=h}}}h=[f.val.stActive,f.val.stRegistered,f.val.stLocked];b=[];m=0;for(g=h.length;!l&&m<g;m++){var p=h[m];for(a=null;!a||a.total_count>a.offset;a.offset+=a.limit){a={offset:a?a.offset:0,status:p};a=f.api("get","users",a);a.users||(a.users=[]);for(var t=0,q=a.users.length;t<q;t++)d=a.users[t],d.status=p,b.push(d)}}l||b.length||(l=2);if(!l)for(m=0,g=b.length;m<g;m++)if(d=b[m],n=d.login.toLowerCase(),h=e[n]){if(a=f.lib.difference(h,d,function(r,u){return r.id==u.id&&r.value!=u.value}))k&&(a.auth_source_id=
k),a={user:a},a=f.api("put","users/"+d.id,a),a.user&&c++;delete e[n]}if(!l)for(n in e)h=e[n],f.val.stActive==h.status&&(k&&(h.auth_source_id=k),a={user:h},a=f.api("post","users",a),a.user&&c++),delete e[n];return c},"issues.change":function(a,d,k){var g,b,e,c,l=0;var m=0;if(!m)if(d=d?f.lib.str2obj(d,!1,f.val.delimKey,f.val.delimVal):null)for(var h in d)(b=d[h])&&(d[h]=b.split('"').join(""));else m=1;if(!m&&(k=k?f.lib.str2obj(k,!1,f.val.delimKey,f.val.delimVal):null))for(h in k)(b=k[h])&&(k[h]=b.split('"').join(""));
if(!m){var n=[];for(e=null;!e||e.total_count>e.offset;e.offset+=e.limit)e={offset:e?e.offset:0},a&&(e.query_id=a),e=f.api("get","issues",e),e.issues&&(n=n.concat(e.issues))}if(!m)for(var p=0,t=n.length;p<t;p++){var q=n[p];q["true"]=!0;q["false"]="";for(g in q){var r=q[g];(g=f.fun.getAttribute("custom",g))&&(q[g]=r)}m=!0;if(k)for(h in k){a=k[h];if(isNaN(h))for(b=e=q,list=h.split(f.val.delimId),u=0,x=list.length;m&&u<x;u++)g=list[u],(m=g in e)&&(b=e=e[g]);else{m=!1;list=q.custom_fields?q.custom_fields:
[];for(var u=0,x=list.length;!m&&u<x;u++)if(r=list[u],m=r.id==Number(h))b=r.value}m&&(a&&(a=f.lib.template(a,q,f.fun.filter)),a=f.fun.str2val(a),f.lib.validate(a,"boolean")&&(b=b?!0:!1),m=!f.lib.compare(a,b),!m&&isNaN(a)&&(a=""+a,b=""+b,a=a.toLowerCase(),m=~b.toLowerCase().indexOf(a)));if(!m)break}if(m){r=null;var y=0;for(h in d){r||(r={});(b=d[h])&&(b=f.lib.template(b,q,f.fun.filter));b=f.fun.str2val(b);h=f.fun.getAttribute("original",h)||h;switch(h){case "watcher":b&&(b=isNaN(b)?!1:Number(b));b&&
(e={include:"watchers"},e=f.api("get","issues/"+q.id,e),e.issue&&e.issue.watchers?c=e.issue.watchers:b=!1);if(b){var w=null;u=0;for(x=c.length;!w&&u<x;u++)w=c[u],Math.abs(b)!=w.id&&(w=null)}b&&(0<b&&!w&&(e={user_id:b},e={watcher:e},f.api("post","issues/"+q.id+"/watchers",e)),0>b&&w&&(b=Math.abs(b),f.api("delete","issues/"+q.id+"/watchers/"+b)));h=null}h&&(isNaN(h)?r[h]=b:(r.custom_fields||(r.custom_fields=[]),r.custom_fields.push({id:h,value:b})),y++)}}m&&y&&(e={issue:r},e=f.api("put","issues/"+q.id,
e),e.issue&&l++)}return l}},api:function(a,d,k){var g={},b=0;if(!b)switch(a.toLowerCase()){case "get":var e=!1;break;case "head":e=!1;break;case "delete":e=!1;break;default:e=!0}!b&&k&&e&&((k=f.fun.obj2xml(k))||(b=1));if(!b){d=f.val.apiUrl+d+".xml";var c={"Cache-Control":"no-store","If-None-Match":"empty"};f.val.apiKey&&(c["X-Redmine-API-Key"]=f.val.apiKey);c=f.lib.sjax(a,d,c,k);k=c.responseXML;f.lib.validate(k,"xml")||(b=2)}b||(k=f.fun.xml2obj(c.responseXML))&&(g=k);return g},init:function(){var a,
d,k,g=[],b=0,e=0,c=0;c||(e<v.arguments.length?(a=v.arguments(e))?((d="/"!=a.substr(a.length-1))&&(a+="/"),f.val.apiUrl=a):c=2:c=1,e++);c||(e<v.arguments.length?(a=v.arguments(e))?f.val.apiKey=a:c=4:c=3,e++);c||(e<v.arguments.length?(a=v.arguments(e),(k=f.method[a])||(c=6)):c=5,e++);if(!c)for(d=e,e=v.arguments.length;d<e;d++)a=v.arguments(d),g.push(a);c||(b=k.apply(f,g));v.quit(c?-1*c:b)}})})(readmine,WSH);readmine.init();
