...
(function(d,q,z){d.lib.extend(d,{fun:{str2val:function(a){switch(!0){case "true"==a:a=!0;break;case "false"==a:a=!1;break;case !isNaN(a):a=Number(a);break;case "--"==a.charAt(4)+a.charAt(7)&&"::"==a.charAt(13)+a.charAt(16)&&"TZ"==a.charAt(10)+a.charAt(19):a=Date.UTC(Number(a.substr(0,4)),Number(a.substr(5,2)),Number(a.substr(8,2)),Number(a.substr(11,2)),Number(a.substr(14,2)),Number(a.substr(17,2))),a=new Date(a)}return a},val2str:function(a){switch(!0){case d.lib.validate(a,"string"):case d.lib.validate(a,
"number"):a=""+a;break;case d.lib.validate(a,"boolean"):a=a?"true":"false";break;case d.lib.validate(a,"date"):a=a.getUTCFullYear()+"-"+d.lib.strPad(a.getUTCMonth(),2,"0","left")+"-"+d.lib.strPad(a.getUTCDate(),2,"0","left")+"T"+d.lib.strPad(a.getUTCHours(),2,"0","left")+":"+d.lib.strPad(a.getUTCMinutes(),2,"0","left")+":"+d.lib.strPad(a.getUTCSeconds(),2,"0","left")+"Z";break;default:a=null}return a},xml2obj:function(a){var c={},b=null,g=!0;if(a){var f=a.documentElement?a.documentElement:a;for(var k=
0,e=f.attributes.length;k<e;k++){var m=f.attributes[k];g=!1;"type"!=m.name&&"array"!=m.value?c[m.name]=d.fun.str2val(m.value):a.documentElement||(b=!0)}b&&(c=[]);k=0;for(e=a.childNodes.length;k<e;k++)switch(f=a.childNodes[k],f.nodeType){case 1:g=!1;m=d.fun.xml2obj(f);b?c.push(m):c[f.nodeName]=m;break;case 3:g=!1,c=d.fun.str2val(f.nodeValue)}}else g=!1;return g?null:c},obj2xml:function(a,c){var b="item",g=null,f=null;var k={custom_fields:"custom_field",memberships:"membership",groups:"group",issues:"issue",
users:"user",roles:"role"};if(c)c.ownerDocument&&(g=c.ownerDocument);else{var e=["MSXML2.DOMDocument.6.0","MSXML2.DOMDocument.3.0","MSXML2.DOMDocument"];for(var m=0,n=e.length;!g&&m<n;m++){var h=e[m];try{g=new ActiveXObject(h)}catch(y){}}e=g.createProcessingInstruction("xml",'version="1.0" encoding="UTF-8"');g.appendChild(e)}if(g){f=g.createDocumentFragment();if(d.lib.validate(a,"array"))for(c&&(c.setAttribute("type","array"),e=c.nodeName,b=k[e]?k[e]:b),m=0,n=a.length;m<n;m++){var l=g.createElement(b);
for(var p in a[m])switch(h=a[m][p],e=d.fun.val2str(h),!0){case "value"==p&&"custom_field"==b:case "membership"==b:case "user"==b:e=h,h={},h[p]=e;case !e:e=d.fun.obj2xml(h,l);l.appendChild(e);break;default:l.setAttribute(p,e)}f.appendChild(l)}if(d.lib.validate(a,"object")){c&&(b=c.nodeName);for(p in a)switch(h=a[p],e=d.fun.val2str(h),!0){case !!e&&"project"==b:case !!e&&"tracker"==b:case !!e&&"priority"==b:case !!e&&"author"==b:case !!e&&"category"==b:c&&c.setAttribute(p,e);break;case !!c||!l&&!e:l=
g.createElement(p),e=e?g.createTextNode(e):d.fun.obj2xml(h,l),l.appendChild(e),f.appendChild(l)}if(!c&&l)for(p in a)h=a[p],(e=d.fun.val2str(h))&&l.setAttribute(p,e)}c||g.appendChild(f)}return c?f:g},item2user:function(a,c){var b={},g=0;g||a||(g=1);g||c||(g=2);if(!g){var f=a.get("userAccountControl");b.status=f&2?d.val.stLocked:d.val.stActive}if(!g)for(var k in c)f=c[k],d.lib.validate(f,"string")&&(f=d.lib.template(f,function(b){var c=!0;var e=a;for(var f=0,g=b.length;c&&f<g;f++){var k=b[f];try{f&&
(e=d.wsh.getLDAP(e)[0]),e?e=e.get(k):c=!1}catch(y){c=!1}}if(c)return e},d.fun.filter)),isNaN(k)?b[k]=f:(b.custom_fields||(b.custom_fields=[]),b.custom_fields.push({id:k,value:f}));return b},filter:function(a,c){a=a?""+a:"";var b=a.split("][").join(d.val.delimId);b=b.split("[").join(d.val.delimId);b=b.split("]").join("");var g=b.split(d.val.delimId);switch(!0){case "phone"==a.toLowerCase():b=c?d.lib.trim(""+c):"";b=b.replace(/\D/g,"");!b.indexOf("8")&&10<b.length&&(b="7"+b.substr(1));a=[{index:0,length:b.length-
10},{index:b.length-10,length:3},{index:b.length-7,length:3},{index:b.length-4,length:2},{index:b.length-2,length:2}];c=0;for(var f=a.length;c<f;c++)g=a[c].length+Math.min(0,a[c].index),a[c]=b.substr(Math.max(0,a[c].index),Math.max(0,g));!a[0]&&a[1]&&(a[0]=7);b=a[0]?"+"+a[0]:"";b+=a[1]?" ("+a[1]+") ":"";b+=a[2]?a[2]+"-":"";b+=a[3]?a[3]+(a[2]?"-":""):"";return b+=a[4]?a[4]:"";case "clear"==a.toLowerCase():return b=c?d.lib.trim(""+c):"",b.charAt(0)==b.charAt(0).toLowerCase()&&(b=b.charAt(0).toUpperCase()+
b.substr(1)),a=".",b.indexOf(a)==b.length-a.length&&(b=b.substr(0,b.length-a.length)),a="FW:",b.indexOf(a)||(b=b.substr(a.length)),a="RE:",b.indexOf(a)||(b=b.substr(a.length)),b=d.lib.trim(b);case "hash"==a.toLowerCase():return b=c?d.lib.trim(""+c):"",b=d.lib.strim(b,"#","",!1,!1);case "user"==g[0].toLowerCase():case "issue"==g[0].toLowerCase():case "project"==g[0].toLowerCase():c&&c.id?(a=g.shift().toLowerCase(),b=a+"s/"+c.id,c=d.api("get",b),c=c[a]?c[a]:null):isNaN(c)?c?(a=g.shift().toLowerCase()+
"s",c={name:c},c=d.api("get",a,c),c=c[a]?c[a][0]:null):c=null:(a=g.shift().toLowerCase(),b=a+"s/"+Number(c),c=d.api("get",b),c=c[a]?c[a]:null);c=b=c;f=0;for(var k=g.length;c&&f<k;f++)if(a=g[f],isNaN(a))(c=a in b)&&(b=b[a]);else if(a=Number(a),c=b=b.custom_fields){c=!1;for(var e=0,m=b.length;!c&&e<m;e++)if(c=a==b[e].id)b=b.value}if(c)return b}}},method:{"users.sync":function(a,c,b){var g,f={},k=0,e=0;if(!e){a=a?d.lib.str2obj(a,!1,d.val.delimKey,d.val.delimVal):{};for(n in a){var m=a[n].split('"').join("");
a[n]=d.fun.str2val(m)}a.login&&a.firstname&&a.mail&&a.lastname||(e=1)}e||(g=d.wsh.getLDAP("WHERE 'objectClass' = 'user'",c));var n=0;for(m=g.length;!e&&n<m;n++){c=g[n];var h=d.fun.item2user(c,a);if(h.login&&h.firstname&&h.lastname){h.mail||(h.status=d.val.stLocked,delete h.mail);var l=h.login.toLowerCase();f[l]=h}}h=[d.val.stActive,d.val.stRegistered,d.val.stLocked];g=[];n=0;for(m=h.length;!e&&n<m;n++){var p=h[n];for(a=null;!a||a.total_count>a.offset;a.offset+=a.limit){a={offset:a?a.offset:0,status:p};
a=d.api("get","users",a);a.users||(a.users=[]);for(var q=0,w=a.users.length;q<w;q++)c=a.users[q],c.status=p,g.push(c)}}e||g.length||(e=2);n=0;for(m=g.length;!e&&n<m;n++)if(c=g[n],l=c.login.toLowerCase(),h=f[l]){if(a=d.lib.difference(h,c,function(a,b){return a.id==b.id&&a.value!=b.value}))b&&(a.auth_source_id=b),a={user:a},a=d.api("put","users/"+c.id,a),a.user&&k++;delete f[l]}if(!e)for(l in f)h=f[l],d.val.stActive==h.status&&(b&&(h.auth_source_id=b),a={user:h},a=d.api("post","users",a),a.user&&k++),
delete f[l];return k},"issues.change":function(a,c,b){var g,f,k=0,e=0;var m={project:"project_id",tracker:"tracker_id",status:"status_id",priority:"priority_id",author:"author_id",assigned:"assigned_to_id",category:"category_id",start:"start_date",due:"due_date",done:"done_ratio",private:"is_private",estimated:"estimated_hours",version:"fixed_version_id",parent:"parent_issue_id"};var n={start:"start_date",due:"due_date",done:"done_ratio",private:"is_private",estimated:"estimated_hours",created:"created_on",
updated:"updated_on",closed:"closed_on"};if(!e)if(c=c?d.lib.str2obj(c,!1,d.val.delimKey,d.val.delimVal):null)for(var h in c){var l=c[h].split('"').join("");c[h]=d.fun.str2val(l)}else e=1;if(!e&&(b=b?d.lib.str2obj(b,!1,d.val.delimKey,d.val.delimVal):null))for(h in b)l=b[h].split('"').join(""),b[h]=d.fun.str2val(l);if(!e){var p=[];for(f=null;!f||f.total_count>f.offset;f.offset+=f.limit)f={offset:f?f.offset:0},a&&(f.query_id=a),f=d.api("get","issues",f),f.issues&&(p=p.concat(f.issues))}for(var q=0,w=
p.length;!e&&q<w;q++){var u=p[q];for(g in u){var r=u[g];(g=n[g]?n[g]:null)&&(u[g]=r)}var t=!0;if(b)for(h in b){a=b[h];if(isNaN(h))for(l=f=u,list=h.split(d.val.delimId),v=0,x=list.length;t&&v<x;v++)g=list[v],(t=g in f)&&(l=f=f[g]);else{t=!1;list=u.custom_fields?u.custom_fields:[];for(var v=0,x=list.length;!t&&v<x;v++)if(r=list[v],t=r.id==Number(h))l=r.value}t&&(d.lib.validate(a,"string")&&(a=d.lib.template(a,u,d.fun.filter)),t=!d.lib.compare(l,a),t||(a=""+a,l=""+l,a=a.toLowerCase(),t=~l.toLowerCase().indexOf(a)));
if(!t)break}if(t)for(h in r=null,c)l=c[h],d.lib.validate(l,"string")&&(l=d.lib.template(l,u,d.fun.filter)),h=m[h]?m[h]:h,r||(r={}),isNaN(h)?r[h]=l:(r.custom_fields||(r.custom_fields=[]),r.custom_fields.push({id:h,value:l}));t&&(f={issue:r},f=d.api("put","issues/"+u.id,f),f.issue&&k++)}return k}},api:function(a,c,b){var g={},f=0;if(!f)switch(a.toLowerCase()){case "get":var k=!1;break;case "head":k=!1;break;case "delete":k=!1;break;default:k=!0}!f&&b&&k&&((b=d.fun.obj2xml(b))||(f=1));if(!f){c=d.val.apiUrl+
c+".xml";var e={"Cache-Control":"no-store","If-None-Match":"empty"};d.val.apiKey&&(e["X-Redmine-API-Key"]=d.val.apiKey);e=d.lib.sjax(a,c,e,b);b=e.responseXML;d.lib.validate(b,"xml")||(f=2)}f||(b=d.fun.xml2obj(e.responseXML))&&(g=b);return g},init:function(){var a,c,b,g=[],f=0,k=0,e=0;e||(k<q.arguments.length?(a=q.arguments(k))?((c="/"!=a.substr(a.length-1))&&(a+="/"),d.val.apiUrl=a):e=2:e=1,k++);e||(k<q.arguments.length?(a=q.arguments(k))?d.val.apiKey=a:e=4:e=3,k++);e||(k<q.arguments.length?(a=q.arguments(k),
(b=d.method[a])||(e=6)):e=5,k++);if(!e)for(c=k,k=q.arguments.length;c<k;c++)a=q.arguments(c),g.push(a);e||(f=b.apply(d,g));q.quit(e?-1*e:f)}})})(readmine,WSH);readmine.init();
