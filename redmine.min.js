...
"number"):a=""+a;break;case d.lib.validate(a,"boolean"):a=a?"true":"false";break;case d.lib.validate(a,"date"):a=a.getUTCFullYear()+"-"+d.lib.strPad(a.getUTCMonth(),2,"0","left")+"-"+d.lib.strPad(a.getUTCDate(),2,"0","left")+"T"+d.lib.strPad(a.getUTCHours(),2,"0","left")+":"+d.lib.strPad(a.getUTCMinutes(),2,"0","left")+":"+d.lib.strPad(a.getUTCSeconds(),2,"0","left")+"Z";break;default:a=null}return a},xml2obj:function(a){var c={},k=null,l=!0;if(a){var b=a.documentElement?a.documentElement:a;for(var g=
0,e=b.attributes.length;g<e;g++){var p=b.attributes[g];l=!1;"type"!=p.name&&"array"!=p.value?c[p.name]=d.fun.str2val(p.value):a.documentElement||(k=!0)}k&&(c=[]);g=0;for(e=a.childNodes.length;g<e;g++)switch(b=a.childNodes[g],b.nodeType){case 1:l=!1;p=d.fun.xml2obj(b);k?c.push(p):c[b.nodeName]=p;break;case 3:l=!1,c=d.fun.str2val(b.nodeValue)}}else l=!1;return l?null:c},obj2xml:function(a,c){var k="item",l=null,b=null;var g={custom_fields:"custom_field",memberships:"membership",groups:"group",issues:"issue",
users:"user",roles:"role"};if(c)c.ownerDocument&&(l=c.ownerDocument);else{var e=["MSXML2.DOMDocument.6.0","MSXML2.DOMDocument.3.0","MSXML2.DOMDocument"];for(var p=0,f=e.length;!l&&p<f;p++){var m=e[p];try{l=new ActiveXObject(m)}catch(q){}}e=l.createProcessingInstruction("xml",'version="1.0" encoding="UTF-8"');l.appendChild(e)}if(l){b=l.createDocumentFragment();if(d.lib.validate(a,"array"))for(c&&(c.setAttribute("type","array"),e=c.nodeName,k=g[e]?g[e]:k),p=0,f=a.length;p<f;p++){var h=l.createElement(k);
for(var n in a[p])switch(m=a[p][n],e=d.fun.val2str(m),!0){case "value"==n&&"custom_field"==k:case "membership"==k:case "user"==k:e=m,m={},m[n]=e;case !e:e=d.fun.obj2xml(m,h);h.appendChild(e);break;default:h.setAttribute(n,e)}b.appendChild(h)}if(d.lib.validate(a,"object")){c&&(k=c.nodeName);for(n in a)switch(m=a[n],e=d.fun.val2str(m),!0){case !!e&&"project"==k:case !!e&&"tracker"==k:case !!e&&"priority"==k:case !!e&&"author"==k:case !!e&&"category"==k:c&&c.setAttribute(n,e);break;case !!c||!h&&!e:h=
l.createElement(n),e=e?l.createTextNode(e):d.fun.obj2xml(m,h),h.appendChild(e),b.appendChild(h)}if(!c&&h)for(n in a)m=a[n],(e=d.fun.val2str(m))&&h.setAttribute(n,e)}c||l.appendChild(b)}return c?b:l},item2user:function(a,c){var k={},l=0;l||a||(l=1);l||c||(l=2);if(!l){var b=a.get("userAccountControl");k.status=b&2?d.val.userLocked:d.val.userActive}if(!l)for(var g in c)(b=c[g])&&(b=d.lib.template(b,function(e){var p=!0;var f=a;for(var m=0,h=e.length;p&&m<h;m++){var n=e[m];try{m&&(f=d.wsh.ldap(f)[0]),
f?f=f.get(n):p=!1}catch(q){p=!1}}if(p)return f},d.fun.filter)),b=d.fun.str2val(b),isNaN(g)?k[g]=b:(k.custom_fields||(k.custom_fields=[]),k.custom_fields.push({id:g,value:b}));return k},getAttribute:function(a,c){var k="";var l={"project.id":["project_id"],"tracker.id":["tracker_id"],"status.id":["status_id"],"priority.id":["priority_id"],"author.id":["author_id"],"assigned_to.id":["assigned_to_id"],"category.id":["category_id"],"fixed_version.id":["fixed_version_id"],"parent.id":["parent_issue_id"]};
switch(a){case "custom":for(var b in l){a=0;for(var g=l[b].length;a<g;a++)c==l[b][a]&&(k=b)}break;case "original":for(b in l)c==b&&(k=l[b][0])}return k},filter:function(a,c){var k,l,b,g=[];a=a?""+a:"";var e="(";var p=")";if(a.indexOf(p)>a.indexOf(e)){var f=d.lib.strim(a,e,p,!1,!1);f=f.split('"').join("").split("'").join("");a=d.lib.strim(a,"",e,!1,!1);g=f.split(d.val.delimParam)}e="[";p="]";f=a.split(p+e).join(d.val.delimId);f=f.split(e).join(d.val.delimId);f=f.split(p).join("");f=f.split('"').join("").split("'").join("");
e=f.split(d.val.delimId);switch(!0){case "phone"==a.toLowerCase():f=c?d.lib.trim(""+c):"";f=f.replace(/\D/g,"");!f.indexOf("8")&&10<f.length&&(f="7"+f.substr(1));var m=[{index:0,length:f.length-10},{index:f.length-10,length:3},{index:f.length-7,length:3},{index:f.length-4,length:2},{index:f.length-2,length:2}];e=0;for(a=m.length;e<a;e++){var h=m[e].length+Math.min(0,m[e].index);m[e]=f.substr(Math.max(0,m[e].index),Math.max(0,h))}!m[0]&&m[1]&&(m[0]=7);f=m[0]?"+"+m[0]:"";f+=m[1]?" ("+m[1]+") ":"";f+=
m[2]?m[2]+"-":"";f+=m[3]?m[3]+(m[2]?"-":""):"";return f+=m[4]?m[4]:"";case "normal"==a.toLowerCase():f=c?d.lib.trim(""+c):"";m=[160];e=0;for(a=m.length;e<a;e++)h=String.fromCharCode(m[e]),f=f.split(h).join("");f=d.lib.trim(f);m=["FW:","RE:"];c=!1;e=0;for(a=m.length;e<a&&!c;e++)h=m[e],(b=f.indexOf(h))||(c=!0);c&&(f=f.substring(b+h.length),f=d.lib.trim(f));m=[".","!","?"];c=!1;e=0;for(a=m.length;e<a&&!c;e++)h=m[e],b=f.indexOf(h),f.length-b==h.length&&(c=!0);c&&(f=f.substring(0,b),f=d.lib.trim(f));f.charAt(0)==
f.charAt(0).toLowerCase()&&(f=f.charAt(0).toUpperCase()+f.substring(1));f=f.split("  ").join(" ");f=f.split(" \n").join("\n");return f=f.split("\n ").join("\n");case "hash"==a.toLowerCase():return f=c?d.lib.trim(""+c):"",f=d.lib.strim(f,"#","",!1,!1);case "set"==a.toLowerCase():f=c?d.lib.trim(""+c):"";b=!0;f=f?0<g.length?g[0]||f:"true":1<g.length?g[1]||(b=!1):"false";if(b)return f;break;case "map"==a.toLowerCase():f=c?d.lib.trim(""+c):"";b=!1;e=0;for(a=g.length;e<a;e++)if(~g[e].indexOf(d.val.delimMap)&&
(h=d.lib.strim(g[e],"",d.val.delimMap,!1,!1),f==h||!f&&!h)){f=d.lib.strim(g[e],d.val.delimMap,"",!1,!1);b=!0;break}if(b)return f;break;case "user"==e[0].toLowerCase():m||(m={include:"groups"});case "issue"==e[0].toLowerCase():m||(m={include:"journals,watchers"});case "project"==e[0].toLowerCase():m||(m={include:"trackers"});(k=c&&c.id?c.id:isNaN(c)?null:c)?(h=e.shift().toLowerCase(),c=d.api.redmine("get",h+"s/"+k,m),c=c[h]?c[h]:null):c?(h=e.shift().toLowerCase()+"s",c={name:c},c=d.api.redmine("get",
h,c),c=c[h]&&1==c[h].length?c[h][0]:null):c=null;b=m=c;c=0;for(l=e.length;b&&c<l;c++)if(h=e[c],isNaN(h))(b=h in m)&&(m=m[h]);else if(h=Number(h),b=m=m.custom_fields)for(b=!1,g=0,p=m.length;!b&&g<p;g++)if(b=h==m[g].id)m=m[g].value;if(b)return m;break;case "journal"==e[0].toLowerCase():k="details";h=e.shift().toLowerCase()+"s";f=e.pop();var n=e.join(d.val.delimId);n=d.fun.getAttribute("original",n)||n;if(c&&c[h])for(e=0,a=c[h].length;e<a;e++)if(c[h][e][k])for(g=0,p=c[h][e][k].length;g<p;g++){m=c[h][e][k][g];
var q=m.new_value||"";q=d.fun.str2val(q);b=d.lib.validate(q,"boolean");b=!d.lib.compare(q,b?f?!0:!1:f);!b&&isNaN(q)&&(b=d.lib.hasValue(""+f,q,!1));if(b=b&&(!n||n==m.name))l=c[h][e].user.id}if(l)return l}},fixUrlPath:function(a){a?"/"!=a.substring(a.length-1)&&(a+="/"):a="/";return a}},method:{"users.sync":function(a,c,k){var l,b,g,e={},p=0;p||(a=d.lib.url2obj(a),d.lib.hasValue(["ldap"],a.scheme,!1)?d.val.apiADPath=a.path||a.domain:p=7);if(!p){c=c?d.lib.str2obj(c,!1,d.val.delimKey,d.val.delimVal):
{};for(b in c)(a=c[b])&&(c[b]=a.split('"').join("").split("'").join("")),l||(l=b);c.login&&c.firstname&&c.mail&&c.lastname||(p=8)}p||(g=d.api.ad("WHERE 'objectClass' = 'user'"));if(!p)for(var f=0,m=g.length;f<m;f++){a=g[f];var h=d.fun.item2user(a,c);h.login&&h.firstname&&h.lastname&&(h.mail||(h.status=d.val.userLocked,delete h.mail),(b=h[l].toLowerCase())&&(e[b]=h))}h=[d.val.userActive,d.val.userRegistered,d.val.userLocked];g=[];f=0;for(m=h.length;!p&&f<m;f++){var n=h[f];for(c=null;!c||c.total_count>
c.offset;c.offset+=c.limit){c={offset:c?c.offset:0,status:n};c=d.api.redmine("get","users",c);c.users||(c.users=[]);for(var q=0,w=c.users.length;q<w;q++)a=c.users[q],a.status=n,g.push(a)}}p||g.length||(p=9);if(!p)for(f=0,m=g.length;f<m;f++)if(a=g[f],b=a[l].toLowerCase(),h=e[b]){if(c=d.lib.difference(h,a,function(r,t){return r.id==t.id&&r.value!=t.value}))k&&(c.auth_source_id=k),c={user:c},c=d.api.redmine("put","users/"+a.id,c);delete e[b]}if(!p)for(b in e)h=e[b],d.val.userActive==h.status&&(k&&(h.auth_source_id=
k),c={user:h},c=d.api.redmine("post","users",c)),delete e[b];return p},"issues.sync":function(a,c,k,l){var b,g,e,p,f,m={},h=0;l||(l=k,k=null);h||c&&!isNaN(c)||(h=7);h||(a=d.lib.url2obj(a),h||(a.fragment?(d.val.apiCherwellClient=a.fragment,delete a.fragment):h=8),h||(a.password&&a.user?(d.val.apiCherwellUser=a.user,d.val.apiCherwellPassword=a.password,delete a.password,delete a.user):h=9),h||(a.scheme&&a.domain?(a.path=d.fun.fixUrlPath(a.path),d.val.apiCherwellUrl=d.lib.obj2url(a)):h=10));if(!h&&(k=
k?d.lib.str2obj(k,!1,d.val.delimKey,d.val.delimVal):null))for(v in k)(b=k[v])&&(k[v]=b.split('"').join("").split("'").join(""));if(!h){l=l?d.lib.str2obj(l,!1,d.val.delimKey,d.val.delimVal):{};for(v in l)(b=l[v])&&(l[v]=b.split('"').join("").split("'").join("")),f||(f=v);if(!l.SuppliersReference||l.IncidentID)h=11}if(!h){var n=d.api.cherwell("get","getuserbyloginid/loginid/"+d.val.apiCherwellUser);n.recordId?g=n.recordId:h=12}h||(n=d.api.cherwell("get","getbusinessobjectsummary/busobname/Incident"),
n.length&&n[0].busObId?e=n[0].busObId:h=13);if(!h)if(n=d.api.cherwell("get","getbusinessobjectschema/busobid/"+e),n.fieldDefinitions){var q=n.fieldDefinitions;var w={};for(v in l){n=!1;var r=[v,"IncidentID"];for(var t=0,y=q.length;t<y;t++){a=q[t];for(var u=0,x=r.length;u<x;u++){var z=r[u];a.name==z&&(w[a.name]=a.fieldId,u||(n=!0))}}n||(h=15)}}else h=14;if(!h)for(t=1,q=[],n=null;!n||n.hasMoreRecords&&!h;t++)n={pagenumber:t},n=d.api.cherwell("get","getsearchresults/association/"+e+"/scope/User/scopeowner/"+
g+"/searchname/"+c,n),!n.hasError&&n.businessObjects?q=q.concat(n.businessObjects):h=16;if(!h)for(t=0,y=q.length;t<y;t++){a=q[t];var B={};u=0;for(x=a.fields.length;u<x;u++)if(p=w[a.fields[u].name]){b=a.fields[u].value;r=[160,13];var v=0;for(n=r.length;b&&v<n;v++)z=String.fromCharCode(r[v]),b=(""+b).split(z).join("");B[p]=b}(v=B[w[f]])&&(m[v]=B)}if(!h)for(q=[],n=null;!n||n.total_count>n.offset;n.offset+=n.limit)n={offset:n?n.offset:0},c&&(n.query_id=c),n=d.api.redmine("get","issues",n),n.issues&&(q=
q.concat(n.issues));if(!h)for(t=0,y=q.length;t<y;t++){a=q[t];a["true"]=!0;a["false"]=!1;for(z in a){var A=a[z];(z=d.fun.getAttribute("custom",z))&&(a[z]=A)}g=!0;if(k)for(v in k){c=k[v];if(isNaN(v))for(b=n=a,r=v.split(d.val.delimId),u=0,x=r.length;g&&u<x;u++)z=r[u],(g=z in n)&&(b=n=n[z]);else for(g=!1,r=a.custom_fields?a.custom_fields:[],u=0,x=r.length;!g&&u<x;u++)if(A=r[u],g=A.id==Number(v))b=A.value;if(g)for(c&&(c=d.lib.template(c,a,d.fun.filter)),r=c.split(d.val.delimParam),g=!1,u=0,x=r.length;u<
x&&!g;u++)c=r[u],c=d.fun.str2val(c),g=d.lib.validate(c,"boolean"),g=!d.lib.compare(c,g?b?!0:!1:b),!g&&isNaN(c)&&(g=d.lib.hasValue(""+b,c,!1));if(!g)break}if(g){B=A=null;var D=0;for(v in l)A||(A={}),(b=l[v])&&(b=d.lib.template(b,a,d.fun.filter)),b=d.fun.str2val(b),p=w[v],v==f&&(B=m[b]),B&&B[p]==b||D++,A[p]=b}if(g&&D){n={busObId:e,persist:!0,fields:[]};B&&(n.busObPublicId=B[w.IncidentID]);for(p in A)n.fields.push({value:A[p],fieldId:p,dirty:!0});d.api.cherwell("post","savebusinessobject",n)}}return h},
"issues.change":function(a,c,k){var l,b,g,e,p=0;isNaN(a)&&(k=c,c=a,a=null);k||(k=c,c=null);if(!p&&(c=c?d.lib.str2obj(c,!1,d.val.delimKey,d.val.delimVal):null))for(var f in c)(b=c[f])&&(c[f]=b.split('"').join("").split("'").join(""));if(!p)if(k=k?d.lib.str2obj(k,!1,d.val.delimKey,d.val.delimVal):null)for(f in k)(b=k[f])&&(k[f]=b.split('"').join("").split("'").join(""));else p=7;if(!p){var m=[];for(g=null;!g||g.total_count>g.offset;g.offset+=g.limit)g={offset:g?g.offset:0},a&&(g.query_id=a),g=d.api.redmine("get",
"issues",g),g.issues&&(m=m.concat(g.issues))}if(!p)for(var h=0,n=m.length;h<n;h++){var q=m[h];q["true"]=!0;q["false"]=!1;for(l in q){var w=q[l];(l=d.fun.getAttribute("custom",l))&&(q[l]=w)}var r=!0;if(c)for(f in c){a=c[f];if(isNaN(f))for(b=g=q,list=f.split(d.val.delimId),t=0,y=list.length;r&&t<y;t++)l=list[t],(r=l in g)&&(b=g=g[l]);else{r=!1;list=q.custom_fields?q.custom_fields:[];for(var t=0,y=list.length;!r&&t<y;t++)if(w=list[t],r=w.id==Number(f))b=w.value}if(r)for(a&&(a=d.lib.template(a,q,d.fun.filter)),
list=a.split(d.val.delimParam),r=!1,t=0,y=list.length;t<y&&!r;t++)a=list[t],a=d.fun.str2val(a),r=d.lib.validate(a,"boolean"),r=!d.lib.compare(a,r?b?!0:!1:b),!r&&isNaN(a)&&(r=d.lib.hasValue(""+b,a,!1));if(!r)break}if(r){w=null;var u=0;for(f in k){w||(w={});(b=k[f])&&(b=d.lib.template(b,q,d.fun.filter));b=d.fun.str2val(b);f=d.fun.getAttribute("original",f)||f;switch(f){case "watcher":b&&(b=isNaN(b)?!1:Number(b));b&&(g={include:"watchers"},g=d.api.redmine("get","issues/"+q.id,g),g.issue&&g.issue.watchers?
e=g.issue.watchers:b=!1);if(b){var x=null;t=0;for(y=e.length;!x&&t<y;t++)x=e[t],Math.abs(b)!=x.id&&(x=null)}b&&(0<b&&!x&&(g={user_id:b},g={watcher:g},d.api.redmine("post","issues/"+q.id+"/watchers",g)),0>b&&x&&(b=Math.abs(b),d.api.redmine("delete","issues/"+q.id+"/watchers/"+b)));f=null}f&&(isNaN(f)?w[f]=b:(w.custom_fields||(w.custom_fields=[]),w.custom_fields.push({id:f,value:b})),u++)}}r&&u&&(g={issue:w},d.api.redmine("put","issues/"+q.id,g))}return p}},api:{redmine:function(a,c,k){var l={},b=0;
if(!b)switch(a.toLowerCase()){case "get":var g=!1;break;case "head":g=!1;break;case "delete":g=!1;break;default:g=!0}!b&&k&&g&&((k=d.fun.obj2xml(k))||(b=1));if(!b){c=d.val.apiReadmineUrl+c+".xml";var e={"Cache-Control":"no-store","If-None-Match":"empty"};d.val.apiReadmineKey&&(e["X-Redmine-API-Key"]=d.val.apiReadmineKey);e=d.lib.xhr(a,c,e,k,!1,null,d.val.apiReadmineUser,d.val.apiReadminePassword);k=e.responseXML;d.lib.validate(k,"xml")||(b=2)}b||(k=d.fun.xml2obj(e.responseXML))&&(l=k);return l},cherwell:function(a,
c,k){var l={},b=0;if(!b&&!d.val.apiCherwellToken){var g=d.val.apiCherwellUrl+"token";var e=new ActiveXObject("MSXML2.ServerXMLHTTP");e.open("POST",g,!1);e.setRequestHeader("Content-Type","application/x-www-form-urlencoded");e.send(d.lib.obj2str({client_id:d.val.apiCherwellClient,username:d.val.apiCherwellUser,password:d.val.apiCherwellPassword,grant_type:"password"},!0));e.responseText&&200==e.status?(g=JSON.parse(e.responseText).access_token)?d.val.apiCherwellToken=g:b=2:b=1}if(!b)switch(a.toLowerCase()){case "get":var p=
!1;break;case "head":p=!1;break;case "delete":p=!1;break;default:p=!0}!b&&k&&p&&(k=JSON.stringify(k));b||!k||p||(k=d.lib.obj2str(k,!0),c=~c.indexOf("?")?c+"&":c+"?",c+=k,k=null);if(!b){g=d.val.apiCherwellUrl+"api/V1/"+c;e=new ActiveXObject("MSXML2.ServerXMLHTTP");e.open(a.toUpperCase(),g,!1);e.setRequestHeader("Accept","application/json");e.setRequestHeader("Content-Type","application/json");e.setRequestHeader("Authorization","Bearer "+d.val.apiCherwellToken);try{k?e.send(k):e.send(),e.responseText&&
200==e.status||(b=4)}catch(f){b=3}}b||(k=JSON.parse(e.responseText))&&(l=k);return l},ad:function(a){return d.wsh.ldap(a,d.val.apiADPath)}},init:function(){var a,c=[],k=0,l=0;if(!l){if(k<C.arguments.length){var b=C.arguments(k);b=d.lib.url2obj(b);!l&&b.fragment&&(b.user||b.password?l=2:(d.val.apiReadmineKey=b.fragment,delete b.fragment));!l&&b.user&&(b.password&&!b.fragment?(d.val.apiReadmineUser=b.user,d.val.apiReadminePassword=b.password,delete b.password,delete b.user):l=3);l||(b.scheme&&b.domain?
(b.path=d.fun.fixUrlPath(b.path),d.val.apiReadmineUrl=d.lib.obj2url(b)):l=4)}else l=1;k++}l||(k<C.arguments.length?(b=C.arguments(k),(a=d.method[b])||(l=6)):l=5,k++);if(!l)for(var g=C.arguments.length;k<g;k++)b=C.arguments(k),c.push(b);l||(l=a.apply(d,c));C.quit(l)}})})(readmine,WSH);readmine.init();
