...
// 0.2.0 взаимодействие с redmine по средствам api
var readmine=new App({apiReadmineUrl:null,apiReadmineKey:null,apiReadmineUser:null,apiReadminePassword:null,apiADPath:null,userActive:1,userRegistered:2,userLocked:3,delimVal:":",delimKey:";",delimId:"."});
(function(d,v,z){d.lib.extend(d,{fun:{str2val:function(b){switch(!0){case "true"==b:b=!0;break;case "false"==b:b=!1;break;case !!b&&!isNaN(b):b=Number(b);break;case "--"==b.charAt(4)+b.charAt(7)&&"::"==b.charAt(13)+b.charAt(16)&&"TZ"==b.charAt(10)+b.charAt(19):b=Date.UTC(Number(b.substr(0,4)),Number(b.substr(5,2)),Number(b.substr(8,2)),Number(b.substr(11,2)),Number(b.substr(14,2)),Number(b.substr(17,2))),b=new Date(b)}return b},val2str:function(b){switch(!0){case d.lib.validate(b,"string"):case d.lib.validate(b,
"number"):b=""+b;break;case d.lib.validate(b,"boolean"):b=b?"true":"false";break;case d.lib.validate(b,"date"):b=b.getUTCFullYear()+"-"+d.lib.strPad(b.getUTCMonth(),2,"0","left")+"-"+d.lib.strPad(b.getUTCDate(),2,"0","left")+"T"+d.lib.strPad(b.getUTCHours(),2,"0","left")+":"+d.lib.strPad(b.getUTCMinutes(),2,"0","left")+":"+d.lib.strPad(b.getUTCSeconds(),2,"0","left")+"Z";break;default:b=null}return b},xml2obj:function(b){var c={},h=null,f=!0;if(b){var a=b.documentElement?b.documentElement:b;for(var g=
0,e=a.attributes.length;g<e;g++){var k=a.attributes[g];f=!1;"type"!=k.name&&"array"!=k.value?c[k.name]=d.fun.str2val(k.value):b.documentElement||(h=!0)}h&&(c=[]);g=0;for(e=b.childNodes.length;g<e;g++)switch(a=b.childNodes[g],a.nodeType){case 1:f=!1;k=d.fun.xml2obj(a);h?c.push(k):c[a.nodeName]=k;break;case 3:f=!1,c=d.fun.str2val(a.nodeValue)}}else f=!1;return f?null:c},obj2xml:function(b,c){var h="item",f=null,a=null;var g={custom_fields:"custom_field",memberships:"membership",groups:"group",issues:"issue",
users:"user",roles:"role"};if(c)c.ownerDocument&&(f=c.ownerDocument);else{var e=["MSXML2.DOMDocument.6.0","MSXML2.DOMDocument.3.0","MSXML2.DOMDocument"];for(var k=0,m=e.length;!f&&k<m;k++){var l=e[k];try{f=new ActiveXObject(l)}catch(p){}}e=f.createProcessingInstruction("xml",'version="1.0" encoding="UTF-8"');f.appendChild(e)}if(f){a=f.createDocumentFragment();if(d.lib.validate(b,"array"))for(c&&(c.setAttribute("type","array"),e=c.nodeName,h=g[e]?g[e]:h),k=0,m=b.length;k<m;k++){var n=f.createElement(h);
for(var q in b[k])switch(l=b[k][q],e=d.fun.val2str(l),!0){case "value"==q&&"custom_field"==h:case "membership"==h:case "user"==h:e=l,l={},l[q]=e;case !e:e=d.fun.obj2xml(l,n);n.appendChild(e);break;default:n.setAttribute(q,e)}a.appendChild(n)}if(d.lib.validate(b,"object")){c&&(h=c.nodeName);for(q in b)switch(l=b[q],e=d.fun.val2str(l),!0){case !!e&&"project"==h:case !!e&&"tracker"==h:case !!e&&"priority"==h:case !!e&&"author"==h:case !!e&&"category"==h:c&&c.setAttribute(q,e);break;case !!c||!n&&!e:n=
f.createElement(q),e=e?f.createTextNode(e):d.fun.obj2xml(l,n),n.appendChild(e),a.appendChild(n)}if(!c&&n)for(q in b)l=b[q],(e=d.fun.val2str(l))&&n.setAttribute(q,e)}c||f.appendChild(a)}return c?a:f},item2user:function(b,c){var h={},f=0;f||b||(f=1);f||c||(f=2);if(!f){var a=b.get("userAccountControl");h.status=a&2?d.val.userLocked:d.val.userActive}if(!f)for(var g in c)(a=c[g])&&(a=d.lib.template(a,function(e){var k=!0;var m=b;for(var l=0,n=e.length;k&&l<n;l++){var q=e[l];try{l&&(m=d.wsh.ldap(m)[0]),
m?m=m.get(q):k=!1}catch(p){k=!1}}if(k)return m},d.fun.filter)),a=d.fun.str2val(a),isNaN(g)?h[g]=a:(h.custom_fields||(h.custom_fields=[]),h.custom_fields.push({id:g,value:a}));return h},getAttribute:function(b,c){var h="";var f={"project.id":["project_id"],"tracker.id":["tracker_id"],"status.id":["status_id"],"priority.id":["priority_id"],"author.id":["author_id"],"assigned_to.id":["assigned_to_id"],"category.id":["category_id"],"fixed_version.id":["fixed_version_id"],"parent.id":["parent_issue_id"]};
switch(b){case "custom":for(var a in f){b=0;for(var g=f[a].length;b<g;b++)c==f[a][b]&&(h=a)}break;case "original":for(a in f)c==a&&(h=f[a][0])}return h},filter:function(b,c){var h,f;b=b?""+b:"";var a=b.split("][").join(d.val.delimId);a=a.split("[").join(d.val.delimId);a=a.split("]").join("");a=a.split('"').join("");a=a.split("'").join("");var g=a.split(d.val.delimId);switch(!0){case "phone"==b.toLowerCase():a=c?d.lib.trim(""+c):"";a=a.replace(/\D/g,"");!a.indexOf("8")&&10<a.length&&(a="7"+a.substr(1));
var e=[{index:0,length:a.length-10},{index:a.length-10,length:3},{index:a.length-7,length:3},{index:a.length-4,length:2},{index:a.length-2,length:2}];for(var k=0,m=e.length;k<m;k++)g=e[k].length+Math.min(0,e[k].index),e[k]=a.substr(Math.max(0,e[k].index),Math.max(0,g));!e[0]&&e[1]&&(e[0]=7);a=e[0]?"+"+e[0]:"";a+=e[1]?" ("+e[1]+") ":"";a+=e[2]?e[2]+"-":"";a+=e[3]?e[3]+(e[2]?"-":""):"";return a+=e[4]?e[4]:"";case "normal"==b.toLowerCase():return a=c?d.lib.trim(""+c):"",b=".",a.indexOf(b)==a.length-
b.length&&(a=a.substr(0,a.length-b.length)),b="FW:",a.indexOf(b)||(a=a.substr(b.length)),b="RE:",a.indexOf(b)||(a=a.substr(b.length)),a=d.lib.trim(a),a.charAt(0)==a.charAt(0).toLowerCase()&&(a=a.charAt(0).toUpperCase()+a.substr(1)),a;case "hash"==b.toLowerCase():return a=c?d.lib.trim(""+c):"",a=d.lib.strim(a,"#","",!1,!1);case "set"==b.toLowerCase():a=(f=a=c?d.lib.trim(""+c):"")?"true":null;if(f)return a;break;case "user"==g[0].toLowerCase():e||(e={include:"groups"});case "issue"==g[0].toLowerCase():e||
(e={include:"journals,watchers"});case "project"==g[0].toLowerCase():e||(e={include:"trackers"});(h=c&&c.id?c.id:isNaN(c)?null:c)?(b=g.shift().toLowerCase(),c=d.api.redmine("get",b+"s/"+h,e),c=c[b]?c[b]:null):c?(b=g.shift().toLowerCase()+"s",c={name:c},c=d.api.redmine("get",b,c),c=c[b]?c[b][0]:null):c=null;f=e=c;a=0;for(k=g.length;f&&a<k;a++)if(b=g[a],isNaN(b))(f=b in e)&&(e=e[b]);else if(b=Number(b),f=e=e.custom_fields){f=!1;for(var l=0,n=e.length;!f&&l<n;l++)if(f=b==e[l].id)e=e[l].value}if(f)return e;
break;case "journal"==g[0].toLowerCase():h="details";b=g.shift().toLowerCase()+"s";var q=g.shift();q=d.fun.getAttribute("original",q)||q;if(c&&c[b])for(k=0,m=c[b].length;k<m;k++)if(c[b][k][h])for(l=0,n=c[b][k][h].length;l<n;l++){e=c[b][k][h][l];a=d.fun.str2val(g[0]||"");var p=e.new_value||"";d.lib.validate(a,"boolean")&&(p=p?!0:!1);f=!d.lib.compare(a,p);!f&&isNaN(a)&&(p=""+p,a=""+a,a=a.toLowerCase(),f=~p.toLowerCase().indexOf(a));if(f=f&&(!q||q==e.name))var r=c[b][k].user.id}if(r)return r}},fixUrlPath:function(b){b?
"/"!=b.substring(b.length-1)&&(b+="/"):b="/";return b}},method:{"users.sync":function(b,c,h){var f,a,g={},e=0;e||(b=d.lib.url2obj(b),d.lib.hasValue(["ldap"],b.scheme,!1)?d.val.apiADPath=b.path||b.domain:e=7);if(!e){c=c?d.lib.str2obj(c,!1,d.val.delimKey,d.val.delimVal):{};for(n in c)(b=c[n])&&(c[n]=b.split('"').join("")),f||(f=n);c.login&&c.firstname&&c.mail&&c.lastname||(e=8)}e||(a=d.api.ad("WHERE 'objectClass' = 'user'"));if(!e)for(var k=0,m=a.length;k<m;k++){b=a[k];var l=d.fun.item2user(b,c);if(l.login&&
l.firstname&&l.lastname){l.mail||(l.status=d.val.userLocked,delete l.mail);var n=l[f].toLowerCase();g[n]=l}}l=[d.val.userActive,d.val.userRegistered,d.val.userLocked];a=[];k=0;for(m=l.length;!e&&k<m;k++){var q=l[k];for(c=null;!c||c.total_count>c.offset;c.offset+=c.limit){c={offset:c?c.offset:0,status:q};c=d.api.redmine("get","users",c);c.users||(c.users=[]);for(var p=0,r=c.users.length;p<r;p++)b=c.users[p],b.status=q,a.push(b)}}e||a.length||(e=9);if(!e)for(k=0,m=a.length;k<m;k++)if(b=a[k],n=b[f].toLowerCase(),
l=g[n]){if(c=d.lib.difference(l,b,function(t,u){return t.id==u.id&&t.value!=u.value}))h&&(c.auth_source_id=h),c={user:c},c=d.api.redmine("put","users/"+b.id,c);delete g[n]}if(!e)for(n in g)l=g[n],d.val.userActive==l.status&&(h&&(l.auth_source_id=h),c={user:l},c=d.api.redmine("post","users",c)),delete g[n];return e},"issues.change":function(b,c,h){var f,a,g,e,k=0;isNaN(b)&&(h=c,c=b,b=null);h||(h=c,c=null);if(!k)if(h=h?d.lib.str2obj(h,!1,d.val.delimKey,d.val.delimVal):null)for(var m in h)(a=h[m])&&
(h[m]=a.split('"').join(""));else k=7;if(!k&&(c=c?d.lib.str2obj(c,!1,d.val.delimKey,d.val.delimVal):null))for(m in c)(a=c[m])&&(c[m]=a.split('"').join(""));if(!k){var l=[];for(g=null;!g||g.total_count>g.offset;g.offset+=g.limit)g={offset:g?g.offset:0},b&&(g.query_id=b),g=d.api.redmine("get","issues",g),g.issues&&(l=l.concat(g.issues))}if(!k)for(var n=0,q=l.length;n<q;n++){var p=l[n];p["true"]=!0;p["false"]="";for(f in p){var r=p[f];(f=d.fun.getAttribute("custom",f))&&(p[f]=r)}var t=!0;if(c)for(m in c){b=
c[m];if(isNaN(m))for(a=g=p,list=m.split(d.val.delimId),u=0,x=list.length;t&&u<x;u++)f=list[u],(t=f in g)&&(a=g=g[f]);else{t=!1;list=p.custom_fields?p.custom_fields:[];for(var u=0,x=list.length;!t&&u<x;u++)if(r=list[u],t=r.id==Number(m))a=r.value}t&&(b&&(b=d.lib.template(b,p,d.fun.filter)),b=d.fun.str2val(b),d.lib.validate(b,"boolean")&&(a=a?!0:!1),t=!d.lib.compare(b,a),!t&&isNaN(b)&&(b=""+b,a=""+a,b=b.toLowerCase(),t=~a.toLowerCase().indexOf(b)));if(!t)break}if(t){r=null;var y=0;for(m in h){r||(r=
{});(a=h[m])&&(a=d.lib.template(a,p,d.fun.filter));a=d.fun.str2val(a);m=d.fun.getAttribute("original",m)||m;switch(m){case "watcher":a&&(a=isNaN(a)?!1:Number(a));a&&(g={include:"watchers"},g=d.api.redmine("get","issues/"+p.id,g),g.issue&&g.issue.watchers?e=g.issue.watchers:a=!1);if(a){var w=null;u=0;for(x=e.length;!w&&u<x;u++)w=e[u],Math.abs(a)!=w.id&&(w=null)}a&&(0<a&&!w&&(g={user_id:a},g={watcher:g},d.api.redmine("post","issues/"+p.id+"/watchers",g)),0>a&&w&&(a=Math.abs(a),d.api.redmine("delete",
"issues/"+p.id+"/watchers/"+a)));m=null}m&&(isNaN(m)?r[m]=a:(r.custom_fields||(r.custom_fields=[]),r.custom_fields.push({id:m,value:a})),y++)}}t&&y&&(g={issue:r},d.api.redmine("put","issues/"+p.id,g))}return k}},api:{redmine:function(b,c,h){var f={},a=0;if(!a)switch(b.toLowerCase()){case "get":var g=!1;break;case "head":g=!1;break;case "delete":g=!1;break;default:g=!0}!a&&h&&g&&((h=d.fun.obj2xml(h))||(a=1));if(!a){c=d.val.apiReadmineUrl+c+".xml";var e={"Cache-Control":"no-store","If-None-Match":"empty"};
d.val.apiReadmineKey&&(e["X-Redmine-API-Key"]=d.val.apiReadmineKey);e=d.lib.xhr(b,c,e,h,!1,null,d.val.apiReadmineUser,d.val.apiReadminePassword);h=e.responseXML;d.lib.validate(h,"xml")||(a=2)}a||(h=d.fun.xml2obj(e.responseXML))&&(f=h);return f},ad:function(b){return d.wsh.ldap(b,d.val.apiADPath)}},init:function(){var b,c=[],h=0,f=0;if(!f){if(h<v.arguments.length){var a=v.arguments(h);a=d.lib.url2obj(a);!f&&a.fragment&&(a.user||a.password?f=2:(d.val.apiReadmineKey=a.fragment,delete a.fragment));!f&&
a.user&&(a.password&&!a.fragment?(d.val.apiReadmineUser=a.user,d.val.apiReadminePassword=a.password,delete a.password,delete a.user):f=3);f||(a.scheme&&a.domain?(a.path=d.fun.fixUrlPath(a.path),d.val.apiReadmineUrl=d.lib.obj2url(a)):f=4)}else f=1;h++}f||(h<v.arguments.length?(a=v.arguments(h),(b=d.method[a])||(f=6)):f=5,h++);if(!f)for(var g=v.arguments.length;h<g;h++)a=v.arguments(h),c.push(a);f||(f=b.apply(d,c));v.quit(f)}})})(readmine,WSH);readmine.init();
