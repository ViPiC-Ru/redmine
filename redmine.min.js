...
"string"):case c.lib.validate(a,"number"):a=""+a;break;case c.lib.validate(a,"boolean"):a=a?"true":"false";break;case c.lib.validate(a,"date"):a=a.getUTCFullYear()+"-"+c.lib.strPad(a.getUTCMonth()+1,2,"0","left")+"-"+c.lib.strPad(a.getUTCDate(),2,"0","left")+"T"+c.lib.strPad(a.getUTCHours(),2,"0","left")+":"+c.lib.strPad(a.getUTCMinutes(),2,"0","left")+":"+c.lib.strPad(a.getUTCSeconds(),2,"0","left")+"Z";break;default:a=null}return a},xml2obj:function(a){var b={},l=null,m=!0;if(a){var e=a.documentElement?
a.documentElement:a;for(var d=0,f=e.attributes.length;d<f;d++){var g=e.attributes[d];m=!1;"type"!=g.name&&"array"!=g.value?b[g.name]=c.fun.str2val(g.value):a.documentElement||(l=!0)}l&&(b=[]);d=0;for(f=a.childNodes.length;d<f;d++)switch(e=a.childNodes[d],e.nodeType){case 1:m=!1;g=c.fun.xml2obj(e);l?b.push(g):b[e.nodeName]=g;break;case 3:m=!1,b=c.fun.str2val(e.nodeValue)}}else m=!1;return m?null:b},obj2xml:function(a,b){var l="item",m=null,e=null;var d={custom_fields:"custom_field",memberships:"membership",
groups:"group",issues:"issue",users:"user",roles:"role"};if(b)b.ownerDocument&&(m=b.ownerDocument);else{var f=["MSXML2.DOMDocument.6.0","MSXML2.DOMDocument.3.0","MSXML2.DOMDocument"];for(var g=0,h=f.length;!m&&g<h;g++){var q=f[g];try{m=new ActiveXObject(q)}catch(r){}}f=m.createProcessingInstruction("xml",'version="1.0" encoding="UTF-8"');m.appendChild(f)}if(m){e=m.createDocumentFragment();if(c.lib.validate(a,"array"))for(b&&(b.setAttribute("type","array"),f=b.nodeName,l=d[f]?d[f]:l),g=0,h=a.length;g<
h;g++){var k=m.createElement(l);for(var n in a[g])switch(q=a[g][n],f=c.fun.val2str(q),!0){case "value"==n&&"custom_field"==l:case "membership"==l:case "user"==l:f=q,q={},q[n]=f;case !f:f=c.fun.obj2xml(q,k);k.appendChild(f);break;default:k.setAttribute(n,f)}e.appendChild(k)}if(c.lib.validate(a,"object")){b&&(l=b.nodeName);for(n in a)switch(q=a[n],f=c.fun.val2str(q),!0){case !!f&&"project"==l:case !!f&&"tracker"==l:case !!f&&"priority"==l:case !!f&&"author"==l:case !!f&&"category"==l:b&&b.setAttribute(n,
f);break;case !!b||!k&&!f:k=m.createElement(n),f=f?m.createTextNode(f):c.fun.obj2xml(q,k),k.appendChild(f),e.appendChild(k)}if(!b&&k)for(n in a)q=a[n],(f=c.fun.val2str(q))&&k.setAttribute(n,f)}b||m.appendChild(e)}return b?e:m},item2user:function(a,b){var l={},m=0;m||a||(m=1);m||b||(m=2);if(!m){var e=a.get("userAccountControl");l.status=e&2?c.val.userLocked:c.val.userActive}if(!m)for(var d in b)(e=b[d])&&(e=c.lib.template(e,function(f){var g=!0;var h=a;for(var q=0,k=f.length;g&&q<k;q++){var n=f[q];
try{q&&(h=c.wsh.ldap(h)[0]),h?h=h.get(n):g=!1}catch(r){g=!1}}if(g)return h},c.fun.filter)),e=c.fun.str2val(e),isNaN(d)?l[d]=e:(l.custom_fields||(l.custom_fields=[]),l.custom_fields.push({id:d,value:e}));return l},getAttribute:function(a,b){var l="";var m={"project.id":["project_id"],"tracker.id":["tracker_id"],"status.id":["status_id"],"priority.id":["priority_id"],"author.id":["author_id"],"assigned_to.id":["assigned_to_id"],"category.id":["category_id"],"fixed_version.id":["fixed_version_id"],"parent.id":["parent_issue_id"]};
switch(a){case "custom":for(var e in m){a=0;for(var d=m[e].length;a<d;a++)b==m[e][a]&&(l=e)}break;case "original":for(e in m)b==e&&(l=m[e][0])}return l},filter:function(a,b){var l,m,e=[];a=a?""+a:"";var d="(";var f=")";if(a.indexOf(f)>a.indexOf(d)){var g=c.lib.strim(a,d,f,!1,!1);g=g.split('"').join("").split("'").join("");a=c.lib.strim(a,"",d,!1,!1);e=g.split(c.val.delimParam)}d="[";f="]";g=a.split(f+d).join(c.val.delimId);g=g.split(d).join(c.val.delimId);g=g.split(f).join("");g=g.split('"').join("").split("'").join("");
f=g.split(c.val.delimId);switch(!0){case "phone"==a.toLowerCase():d=b?c.lib.trim(""+b):"";d=d.replace(/\D/g,"");!d.indexOf("8")&&10<d.length&&(d="7"+d.substr(1));var h=[{index:0,length:d.length-10},{index:d.length-10,length:3},{index:d.length-7,length:3},{index:d.length-4,length:2},{index:d.length-2,length:2}];f=0;for(var q=h.length;f<q;f++){var k=h[f].length+Math.min(0,h[f].index);h[f]=d.substr(Math.max(0,h[f].index),Math.max(0,k))}!h[0]&&h[1]&&(h[0]=7);d=h[0]?"+"+h[0]:"";d+=h[1]?" ("+h[1]+") ":
"";d+=h[2]?h[2]+"-":"";d+=h[3]?h[3]+(h[2]?"-":""):"";return d+=h[4]?h[4]:"";case "normal"==a.toLowerCase():d=b?c.lib.trim(""+b):"";h=[160];g=d;f=0;for(q=h.length;f<q;f++)k=String.fromCharCode(h[f]),g=g.split(k).join("");d=c.lib.trim(g);h=["FW:","RE:"];var n=!1;f=0;for(q=h.length;f<q&&!n;f++)k=h[f],(l=d.indexOf(k))||(n=!0);n&&(g=d.substring(l+k.length),d=c.lib.trim(g));h=[".","!","?"];n=!1;f=0;for(q=h.length;f<q&&!n;f++)k=h[f],l=d.indexOf(k),d.length-l==k.length&&(n=!0);n&&(g=d.substring(0,l),d=c.lib.trim(g));
g=d;g.charAt(0)==g.charAt(0).toLowerCase()&&(g=g.charAt(0).toUpperCase()+g.substring(1));g=g.split("  ").join(" ");g=g.split(" \n").join("\n");return g=g.split("\n ").join("\n");case "crop"==a.toLowerCase():d=b?c.lib.trim(""+b):"";var r="**";h=["Importance:","Subject:","From:"];n=!1;var u=d.split("\n");f=0;for(q=h.length;f<q&&!n;f++){var p=0;for(e=u.length;p<e&&!n;p++)for(g=u[p],b=0,m=2;b<m&&!n;b++)k=b?h[f]:r+h[f],(l=g.indexOf(k))||(n=!0)}n&&(g=u.slice(p).join("\n"),d=c.lib.trim(g));g=d;g.charAt(0)==
g.charAt(0).toLowerCase()&&(g=g.charAt(0).toUpperCase()+g.substring(1));return g;case "hash"==a.toLowerCase():return d=b?c.lib.trim(""+b):"",d=c.lib.strim(d,"#","",!1,!1);case "set"==a.toLowerCase():d=b?c.lib.trim(""+b):"";a=!0;d=d?0<e.length?e[0]||d:"true":1<e.length?e[1]||(a=!1):"false";if(a)return d;break;case "map"==a.toLowerCase():d=b?c.lib.trim(""+b):"";a=!1;f=0;for(q=e.length;f<q&&!a;f++)~e[f].indexOf(c.val.delimMap)&&(k=c.lib.strim(e[f],"",c.val.delimMap,!1,!1),"*"==k||d==k||!d&&!k)&&(d=c.lib.strim(e[f],
c.val.delimMap,"",!1,!1),a=!0);if(a)return d;break;case "replace"==a.toLowerCase():return d=b?""+b:"",e[0]&&(d=d.split(e[0]).join(e[1]||"")),d;case "context"==f[0].toLowerCase():d=b?c.lib.trim(""+b):"";a=!1;switch(f[1]){case "from":r="**";h=["From:"];n=!1;u=d.split("\n");f=0;for(q=h.length;f<q&&!n;f++)for(p=0,e=u.length;p<e&&!n;p++)for(g=u[p],b=0,m=2;b<m&&!n;b++)k=b?h[f]:r+h[f],(l=g.indexOf(k))||(n=!0);n&&(g=d.substring(l+k.length),d="<",f=">",g.indexOf(f)>g.indexOf(d)&&(g=c.lib.strim(g,d,f,!1,!1)),
d="(mailto:",f=")",g.indexOf(f)>g.indexOf(d)&&(g=c.lib.strim(g,d,f,!1,!1)),(d=c.lib.trim(g))&&(a=!0))}if(a)return d;break;case "user"==f[0].toLowerCase():h||(h={include:"groups"});case "issue"==f[0].toLowerCase():h||(h={include:"journals,watchers"});case "project"==f[0].toLowerCase():h||(h={include:"trackers"});(l=b&&b.id?b.id:isNaN(b)?null:b)?(k=f.shift().toLowerCase(),b=c.api.redmine("get",k+"s/"+l,h),b=b[k]?b[k]:null):b?(k=f.shift().toLowerCase()+"s",b={name:b},b=c.api.redmine("get",k,b),b=b[k]&&
1==b[k].length?b[k][0]:null):b=null;a=h=b;b=0;for(m=f.length;a&&b<m;b++)if(k=f[b],isNaN(k))(a=k in h)&&(h=h[k]);else if(k=Number(k),a=h=h.custom_fields)for(a=!1,p=0,e=h.length;!a&&p<e;p++)if(a=k==h[p].id)h=h[p].value;if(a)return h;break;case "journal"==f[0].toLowerCase():l="details";k=f.shift().toLowerCase()+"s";d=f.pop();g=f.join(c.val.delimId);g=c.fun.getAttribute("original",g)||g;if(b&&b[k])for(f=0,q=b[k].length;f<q;f++)if(b[k][f][l])for(p=0,e=b[k][f][l].length;p<e;p++)if(h=b[k][f][l][p],r=h.new_value||
"",r=c.fun.str2val(r),a=c.lib.validate(r,"boolean"),a=!c.lib.compare(r,a?d?!0:!1:d),!a&&isNaN(r)&&(a=c.lib.hasValue(""+d,r,!1)),a=a&&(!g||g==h.name))m=b[k][f].user.id;if(m)return m}},fixUrlPath:function(a){a?"/"!=a.substring(a.length-1)&&(a+="/"):a="/";return a}},method:{"users.sync":function(a,b,l){var m,e,d,f={},g=0;g||(a=c.lib.url2obj(a),c.lib.hasValue(["ldap"],a.scheme,!1)?c.val.apiADPath=a.path||a.domain:g=7);if(!g){b=b?c.lib.str2obj(b,!1,c.val.delimKey,c.val.delimVal):{};for(e in b)(a=b[e])&&
(b[e]=a.split('"').join("").split("'").join("")),m||(m=e);b.login&&b.firstname&&b.mail&&b.lastname||(g=8)}g||(d=c.api.ad("WHERE 'objectClass' = 'user'"));if(!g)for(var h=0,q=d.length;h<q;h++){a=d[h];var k=c.fun.item2user(a,b);k.login&&k.firstname&&k.lastname&&(k.mail||(k.status=c.val.userLocked,delete k.mail),(e=k[m].toLowerCase())&&(f[e]=k))}k=[c.val.userActive,c.val.userRegistered,c.val.userLocked];d=[];h=0;for(q=k.length;!g&&h<q;h++){var n=k[h];for(b=null;!b||b.total_count>b.offset;b.offset+=b.limit){b=
{offset:b?b.offset:0,status:n};b=c.api.redmine("get","users",b);b.users||(b.users=[]);for(var r=0,u=b.users.length;r<u;r++)a=b.users[r],a.status=n,d.push(a)}}g||d.length||(g=9);if(!g)for(h=0,q=d.length;h<q;h++)if(a=d[h],e=a[m].toLowerCase(),k=f[e]){if(b=c.lib.difference(k,a,function(p,t){return p.id==t.id&&p.value!=t.value}))l&&(b.auth_source_id=l),b={user:b},b=c.api.redmine("put","users/"+a.id,b);delete f[e]}if(!g)for(e in f)k=f[e],c.val.userActive==k.status&&(l&&(k.auth_source_id=l),b={user:k},
b=c.api.redmine("post","users",b)),delete f[e];return g},"issues.sync":function(a,b,l,m){var e,d,f,g,h,q={},k=0;m||(m=l,l=null);k||b&&!isNaN(b)||(k=7);k||(a=c.lib.url2obj(a),k||(a.fragment?(c.val.apiCherwellClient=a.fragment,delete a.fragment):k=8),k||(a.password&&a.user?(c.val.apiCherwellUser=a.user,c.val.apiCherwellPassword=a.password,delete a.password,delete a.user):k=9),k||(a.scheme&&a.domain?(a.path=c.fun.fixUrlPath(a.path),c.val.apiCherwellUrl=c.lib.obj2url(a)):k=10));if(!k&&(l=l?c.lib.str2obj(l,
!1,c.val.delimKey,c.val.delimVal):null))for(w in l)(e=l[w])&&(l[w]=e.split('"').join("").split("'").join(""));if(!k){m=m?c.lib.str2obj(m,!1,c.val.delimKey,c.val.delimVal):{};for(w in m)(e=m[w])&&(m[w]=e.split('"').join("").split("'").join("")),h||(h=w);if(!m.SuppliersReference||m.IncidentID)k=11}if(!k){var n=c.api.cherwell("get","getuserbyloginid/loginid/"+c.val.apiCherwellUser);n.recordId?d=n.recordId:k=12}k||(n=c.api.cherwell("get","getbusinessobjectsummary/busobname/Incident"),n.length&&n[0].busObId?
f=n[0].busObId:k=13);if(!k)if(n=c.api.cherwell("get","getbusinessobjectschema/busobid/"+f),n.fieldDefinitions){var r=n.fieldDefinitions;var u={};for(w in m){n=!1;var p=[w,"IncidentID"];for(var t=0,y=r.length;t<y;t++){a=r[t];for(var v=0,x=p.length;v<x;v++){var z=p[v];a.name==z&&(u[a.name]=a.fieldId,v||(n=!0))}}n||(k=15)}}else k=14;if(!k)for(t=1,r=[],n=null;!n||n.hasMoreRecords&&!k;t++)n={pagenumber:t},n=c.api.cherwell("get","getsearchresults/association/"+f+"/scope/User/scopeowner/"+d+"/searchname/"+
b,n),!n.hasError&&n.businessObjects?r=r.concat(n.businessObjects):k=16;if(!k)for(t=0,y=r.length;t<y;t++){a=r[t];var B={};v=0;for(x=a.fields.length;v<x;v++)if(g=u[a.fields[v].name]){e=a.fields[v].value;p=[160,13];var w=0;for(n=p.length;e&&w<n;w++)z=String.fromCharCode(p[w]),e=(""+e).split(z).join("");B[g]=e}(w=B[u[h]])&&(q[w]=B)}if(!k)for(r=[],n=null;!n||n.total_count>n.offset;n.offset+=n.limit)n={offset:n?n.offset:0},b&&(n.query_id=b),n=c.api.redmine("get","issues",n),n.issues&&(r=r.concat(n.issues));
if(!k)for(t=0,y=r.length;t<y;t++){a=r[t];a["true"]=!0;a["false"]=!1;for(z in a){var A=a[z];(z=c.fun.getAttribute("custom",z))&&(a[z]=A)}d=!0;if(l)for(w in l){b=l[w];if(isNaN(w))for(e=n=a,p=w.split(c.val.delimId),v=0,x=p.length;d&&v<x;v++)z=p[v],(d=z in n)&&(e=n=n[z]);else for(d=!1,p=a.custom_fields?a.custom_fields:[],v=0,x=p.length;!d&&v<x;v++)if(A=p[v],d=A.id==Number(w))e=A.value;if(d)for(b&&(b=c.lib.template(b,a,c.fun.filter)),p=b.split(c.val.delimParam),d=!1,v=0,x=p.length;v<x&&!d;v++)b=p[v],b=
c.fun.str2val(b),d=c.lib.validate(b,"boolean"),d=!c.lib.compare(b,d?e?!0:!1:e),!d&&isNaN(b)&&(d=c.lib.hasValue(""+e,b,!1));if(!d)break}if(d){B=A=null;var D=0;for(w in m)A||(A={}),(e=m[w])&&(e=c.lib.template(e,a,c.fun.filter)),e=c.fun.str2val(e),g=u[w],w==h&&(B=q[e]),B&&B[g]==e||D++,A[g]=e}if(d&&D){n={busObId:f,persist:!0,fields:[]};B&&(n.busObPublicId=B[u.IncidentID]);for(g in A)n.fields.push({value:A[g],fieldId:g,dirty:!0});c.api.cherwell("post","savebusinessobject",n)}}return k},"issues.change":function(a,
b,l){var m,e,d,f,g=0;isNaN(a)&&(l=b,b=a,a=null);l||(l=b,b=null);if(!g&&(b=b?c.lib.str2obj(b,!1,c.val.delimKey,c.val.delimVal):null))for(var h in b)(e=b[h])&&(b[h]=e.split('"').join("").split("'").join(""));if(!g)if(l=l?c.lib.str2obj(l,!1,c.val.delimKey,c.val.delimVal):null)for(h in l)(e=l[h])&&(l[h]=e.split('"').join("").split("'").join(""));else g=7;if(!g){var q=[];for(d=null;!d||d.total_count>d.offset;d.offset+=d.limit)d={offset:d?d.offset:0},a&&(d.query_id=a),d=c.api.redmine("get","issues",d),
d.issues&&(q=q.concat(d.issues))}if(!g)for(var k=0,n=q.length;k<n;k++){var r=q[k];r["true"]=!0;r["false"]=!1;for(m in r){var u=r[m];(m=c.fun.getAttribute("custom",m))&&(r[m]=u)}var p=!0;if(b)for(h in b){a=b[h];if(isNaN(h))for(e=d=r,list=h.split(c.val.delimId),t=0,y=list.length;p&&t<y;t++)m=list[t],(p=m in d)&&(e=d=d[m]);else{p=!1;list=r.custom_fields?r.custom_fields:[];for(var t=0,y=list.length;!p&&t<y;t++)if(u=list[t],p=u.id==Number(h))e=u.value}if(p)for(a&&(a=c.lib.template(a,r,c.fun.filter)),list=
a.split(c.val.delimParam),p=!1,t=0,y=list.length;t<y&&!p;t++)a=list[t],a=c.fun.str2val(a),p=c.lib.validate(a,"boolean"),p=!c.lib.compare(a,p?e?!0:!1:e),!p&&isNaN(a)&&(p=c.lib.hasValue(""+e,a,!1));if(!p)break}if(p){u=null;var v=0;for(h in l){u||(u={});(e=l[h])&&(e=c.lib.template(e,r,c.fun.filter));e=c.fun.str2val(e);h=c.fun.getAttribute("original",h)||h;switch(h){case "watcher":e&&(e=isNaN(e)?!1:Number(e));e&&(d={include:"watchers"},d=c.api.redmine("get","issues/"+r.id,d),d.issue&&d.issue.watchers?
f=d.issue.watchers:e=!1);if(e){var x=null;t=0;for(y=f.length;!x&&t<y;t++)x=f[t],Math.abs(e)!=x.id&&(x=null)}e&&(0<e&&!x&&(d={user_id:e},d={watcher:d},c.api.redmine("post","issues/"+r.id+"/watchers",d)),0>e&&x&&(e=Math.abs(e),c.api.redmine("delete","issues/"+r.id+"/watchers/"+e)));h=null}h&&(isNaN(h)?u[h]=e:(u.custom_fields||(u.custom_fields=[]),u.custom_fields.push({id:h,value:e})),v++)}}p&&v&&(d={issue:u},c.api.redmine("put","issues/"+r.id,d))}return g}},api:{redmine:function(a,b,l){var m={},e=0;
if(!e)switch(a.toLowerCase()){case "get":var d=!1;break;case "head":d=!1;break;case "delete":d=!1;break;default:d=!0}!e&&l&&d&&((l=c.fun.obj2xml(l))||(e=1));if(!e){b=c.val.apiReadmineUrl+b+".xml";var f={"Cache-Control":"no-store","If-None-Match":"empty"};c.val.apiReadmineKey&&(f["X-Redmine-API-Key"]=c.val.apiReadmineKey);f=c.lib.xhr(a,b,f,l,!1,null,c.val.apiReadmineUser,c.val.apiReadminePassword);l=f.responseXML;c.lib.validate(l,"xml")||(e=2)}e||(l=c.fun.xml2obj(f.responseXML))&&(m=l);return m},cherwell:function(a,
b,l){var m={},e=0;if(!e&&!c.val.apiCherwellToken){var d=c.val.apiCherwellUrl+"token";var f=new ActiveXObject("MSXML2.ServerXMLHTTP");f.open("POST",d,!1);f.setRequestHeader("Content-Type","application/x-www-form-urlencoded");f.send(c.lib.obj2str({client_id:c.val.apiCherwellClient,username:c.val.apiCherwellUser,password:c.val.apiCherwellPassword,grant_type:"password"},!0));f.responseText&&200==f.status?(d=JSON.parse(f.responseText).access_token)?c.val.apiCherwellToken=d:e=2:e=1}if(!e)switch(a.toLowerCase()){case "get":var g=
!1;break;case "head":g=!1;break;case "delete":g=!1;break;default:g=!0}!e&&l&&g&&(l=JSON.stringify(l));e||!l||g||(l=c.lib.obj2str(l,!0),b=~b.indexOf("?")?b+"&":b+"?",b+=l,l=null);if(!e){d=c.val.apiCherwellUrl+"api/V1/"+b;f=new ActiveXObject("MSXML2.ServerXMLHTTP");f.open(a.toUpperCase(),d,!1);f.setRequestHeader("Accept","application/json");f.setRequestHeader("Content-Type","application/json");f.setRequestHeader("Authorization","Bearer "+c.val.apiCherwellToken);try{l?f.send(l):f.send(),f.responseText&&
200==f.status||(e=4)}catch(h){e=3}}e||(l=JSON.parse(f.responseText))&&(m=l);return m},ad:function(a){return c.wsh.ldap(a,c.val.apiADPath)}},init:function(){var a,b=[],l=0,m=0;if(!m){if(l<C.arguments.length){var e=C.arguments(l);e=c.lib.url2obj(e);!m&&e.fragment&&(e.user||e.password?m=2:(c.val.apiReadmineKey=e.fragment,delete e.fragment));!m&&e.user&&(e.password&&!e.fragment?(c.val.apiReadmineUser=e.user,c.val.apiReadminePassword=e.password,delete e.password,delete e.user):m=3);m||(e.scheme&&e.domain?
(e.path=c.fun.fixUrlPath(e.path),c.val.apiReadmineUrl=c.lib.obj2url(e)):m=4)}else m=1;l++}m||(l<C.arguments.length?(e=C.arguments(l),(a=c.method[e])||(m=6)):m=5,l++);if(!m)for(var d=C.arguments.length;l<d;l++)e=C.arguments(l),b.push(e);m||(m=a.apply(c,b));C.quit(m)}})})(readmine,WSH);readmine.init();
