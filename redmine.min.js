...
// 0.1.1 библиотека функций общего назначения
...
// 0.1.1 функци для работы в среде windows script host
...
case "lastnamefirstname":b=[c.lastname,c.firstname].join("");break;case "lastname_comma_firstname":b=[c.lastname,c.firstname].join(", ");break;case "lastname":b=c.lastname;break;case "username":b=c.login}}isNaN(p)?e[p]=b:(e.custom_fields||(e.custom_fields=[]),e.custom_fields.push({id:p,value:b}))}return e}},method:{"users.sync":function(a,f,g,k){var e,c={},b=0,m=0;if(!m)if(a=a?d.lib.str2obj(a,!1,d.val.delimKey,d.val.delimVal):{},a.login&&a.firstname&&a.lastname&&a.mail)for(var p in a){var h=a[p].split("'").join("");
